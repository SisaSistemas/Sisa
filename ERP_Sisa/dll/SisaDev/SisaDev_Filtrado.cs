...
namespace SisaDev
{
  ...
  [XmlRoot("SisaDev_Filtrado")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class SisaDev_Filtrado : DataSet
  {
    private SisaDev_Filtrado.sp_AdministracionDataTable tablesp_Administracion;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected SisaDev_Filtrado(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (sp_Administracion)] != null)
            base.Tables.Add((DataTable) new SisaDev_Filtrado.sp_AdministracionDataTable(dataSet.Tables[nameof (sp_Administracion)]));
    ...
    public SisaDev_Filtrado.sp_AdministracionDataTable sp_Administracion => this.tablesp_Administracion;
    ...
    {
      SisaDev_Filtrado sisaDevFiltrado = (SisaDev_Filtrado) base.Clone();
      sisaDevFiltrado.InitVars();
      sisaDevFiltrado.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) sisaDevFiltrado;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["sp_Administracion"] != null)
          base.Tables.Add((DataTable) new SisaDev_Filtrado.sp_AdministracionDataTable(dataSet.Tables["sp_Administracion"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tablesp_Administracion = (SisaDev_Filtrado.sp_AdministracionDataTable) base.Tables["sp_Administracion"];
    ...
    {
      this.DataSetName = nameof (SisaDev_Filtrado);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/SisaDev_Filtrado.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tablesp_Administracion = new SisaDev_Filtrado.sp_AdministracionDataTable();
    ...
    {
      SisaDev_Filtrado sisaDevFiltrado = new SisaDev_Filtrado();
      XmlSchemaComplexType schemaComplexType = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = sisaDevFiltrado.Namespace
      });
      schemaComplexType.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = sisaDevFiltrado.GetSchemaSerializable();
    ...
    public delegate void sp_AdministracionRowChangeEventHandler(
      object sender,
      SisaDev_Filtrado.sp_AdministracionRowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class sp_AdministracionDataTable : TypedTableBase<SisaDev_Filtrado.sp_AdministracionRow>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_Filtrado.sp_AdministracionRow this[int index] => (SisaDev_Filtrado.sp_AdministracionRow) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_Filtrado.sp_AdministracionRowChangeEventHandler sp_AdministracionRowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_Filtrado.sp_AdministracionRowChangeEventHandler sp_AdministracionRowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_Filtrado.sp_AdministracionRowChangeEventHandler sp_AdministracionRowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_Filtrado.sp_AdministracionRowChangeEventHandler sp_AdministracionRowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void Addsp_AdministracionRow(SisaDev_Filtrado.sp_AdministracionRow row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_Filtrado.sp_AdministracionRow Addsp_AdministracionRow(
        long ID,
        ...
        DateTime FechaAlta)
      {
        SisaDev_Filtrado.sp_AdministracionRow administracionRow = (SisaDev_Filtrado.sp_AdministracionRow) this.NewRow();
      ...
      {
        SisaDev_Filtrado.sp_AdministracionDataTable administracionDataTable = (SisaDev_Filtrado.sp_AdministracionDataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new SisaDev_Filtrado.sp_AdministracionDataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_Filtrado.sp_AdministracionRow Newsp_AdministracionRow() => (SisaDev_Filtrado.sp_AdministracionRow) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new SisaDev_Filtrado.sp_AdministracionRow(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (SisaDev_Filtrado.sp_AdministracionRow);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_AdministracionRowChanged == null)
          return;
        this.sp_AdministracionRowChanged((object) this, new SisaDev_Filtrado.sp_AdministracionRowChangeEvent((SisaDev_Filtrado.sp_AdministracionRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_AdministracionRowChanging == null)
          return;
        this.sp_AdministracionRowChanging((object) this, new SisaDev_Filtrado.sp_AdministracionRowChangeEvent((SisaDev_Filtrado.sp_AdministracionRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_AdministracionRowDeleted == null)
          return;
        this.sp_AdministracionRowDeleted((object) this, new SisaDev_Filtrado.sp_AdministracionRowChangeEvent((SisaDev_Filtrado.sp_AdministracionRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_AdministracionRowDeleting == null)
          return;
        this.sp_AdministracionRowDeleting((object) this, new SisaDev_Filtrado.sp_AdministracionRowChangeEvent((SisaDev_Filtrado.sp_AdministracionRow) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void Removesp_AdministracionRow(SisaDev_Filtrado.sp_AdministracionRow row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = sisaDevFiltrado.Namespace
        });
        schemaComplexType.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class sp_AdministracionRow : DataRow
    {
      ...
      internal sp_AdministracionRow(DataRowBuilder rb)
        : base(rb)
      {
        this.tablesp_Administracion = (SisaDev_Filtrado.sp_AdministracionDataTable) this.Table;
      }
    ...
    {
      private SisaDev_Filtrado.sp_AdministracionRow eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public sp_AdministracionRowChangeEvent(
        SisaDev_Filtrado.sp_AdministracionRow row,
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_Filtrado.sp_AdministracionRow Row => this.eventRow;
