...
// Type: SisaDev.SisaDevEficiencia2
...
namespace SisaDev
{
  ...
  [XmlRoot("SisaDevEficiencia2")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class SisaDevEficiencia2 : DataSet
  {
    private SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable tablesp_ReporteProyectosEficienciasVistas;
    private SchemaSerializationMode _schemaSerializationMode = SchemaSerializationMode.IncludeSchema;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public SisaDevEficiencia2()
    {
      this.BeginInit();
      this.InitClass();
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected SisaDevEficiencia2(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (sp_ReporteProyectosEficienciasVistas)] != null)
            base.Tables.Add((DataTable) new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable(dataSet.Tables[nameof (sp_ReporteProyectosEficienciasVistas)]));
    ...
    public SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable sp_ReporteProyectosEficienciasVistas => this.tablesp_ReporteProyectosEficienciasVistas;
    ...
    {
      SisaDevEficiencia2 sisaDevEficiencia2 = (SisaDevEficiencia2) base.Clone();
      sisaDevEficiencia2.InitVars();
      sisaDevEficiencia2.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) sisaDevEficiencia2;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["sp_ReporteProyectosEficienciasVistas"] != null)
          base.Tables.Add((DataTable) new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable(dataSet.Tables["sp_ReporteProyectosEficienciasVistas"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tablesp_ReporteProyectosEficienciasVistas = (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable) base.Tables["sp_ReporteProyectosEficienciasVistas"];
    ...
    {
      this.DataSetName = nameof (SisaDevEficiencia2);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/SisaDevEficiencia2.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tablesp_ReporteProyectosEficienciasVistas = new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable();
    ...
    {
      SisaDevEficiencia2 sisaDevEficiencia2 = new SisaDevEficiencia2();
      XmlSchemaComplexType schemaComplexType = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = sisaDevEficiencia2.Namespace
      });
      schemaComplexType.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = sisaDevEficiencia2.GetSchemaSerializable();
    ...
    public delegate void sp_ReporteProyectosEficienciasVistasRowChangeEventHandler(
      object sender,
      SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class sp_ReporteProyectosEficienciasVistasDataTable : 
      TypedTableBase<SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow this[
        int index]
      {
        return (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) this.Rows[index];
      }

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEventHandler sp_ReporteProyectosEficienciasVistasRowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEventHandler sp_ReporteProyectosEficienciasVistasRowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEventHandler sp_ReporteProyectosEficienciasVistasRowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEventHandler sp_ReporteProyectosEficienciasVistasRowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void Addsp_ReporteProyectosEficienciasVistasRow(
        SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow row)
      {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow Addsp_ReporteProyectosEficienciasVistasRow(
        Guid IdProyecto,
        ...
        Decimal Resultado)
      {
        SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow eficienciasVistasRow = (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) this.NewRow();
      ...
      {
        SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable eficienciasVistasDataTable = (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow Newsp_ReporteProyectosEficienciasVistasRow() => (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_ReporteProyectosEficienciasVistasRowChanged == null)
          return;
        this.sp_ReporteProyectosEficienciasVistasRowChanged((object) this, new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEvent((SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_ReporteProyectosEficienciasVistasRowChanging == null)
          return;
        this.sp_ReporteProyectosEficienciasVistasRowChanging((object) this, new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEvent((SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_ReporteProyectosEficienciasVistasRowDeleted == null)
          return;
        this.sp_ReporteProyectosEficienciasVistasRowDeleted((object) this, new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEvent((SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_ReporteProyectosEficienciasVistasRowDeleting == null)
          return;
        this.sp_ReporteProyectosEficienciasVistasRowDeleting((object) this, new SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRowChangeEvent((SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow) e.Row, e.Action));
      }
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = sisaDevEficiencia2.Namespace
        });
        schemaComplexType.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class sp_ReporteProyectosEficienciasVistasRow : DataRow
    {
      ...
      internal sp_ReporteProyectosEficienciasVistasRow(DataRowBuilder rb)
        : base(rb)
      {
        this.tablesp_ReporteProyectosEficienciasVistas = (SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasDataTable) this.Table;
      }
    ...
    {
      private SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow eventRow;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDevEficiencia2.sp_ReporteProyectosEficienciasVistasRow Row => this.eventRow;
