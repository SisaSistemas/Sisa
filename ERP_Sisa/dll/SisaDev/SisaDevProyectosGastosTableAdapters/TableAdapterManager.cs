...
// Type: SisaDev.SisaDevProyectosGastosTableAdapters.TableAdapterManager
...
namespace SisaDev.SisaDevProyectosGastosTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      SisaDevProyectosGastos dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(SisaDevProyectosGastos dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(SisaDevProyectosGastos dataSet, List<DataRow> allChangedRows) => 0;
