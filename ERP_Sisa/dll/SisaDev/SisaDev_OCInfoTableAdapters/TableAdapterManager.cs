...
// Type: SisaDev.SisaDev_OCInfoTableAdapters.TableAdapterManager
...
namespace SisaDev.SisaDev_OCInfoTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(SisaDev_OCInfo dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(SisaDev_OCInfo dataSet, List<DataRow> allChangedRows) => 0;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    public virtual int UpdateAll(SisaDev_OCInfo dataSet)
    {
      if (dataSet == null)
