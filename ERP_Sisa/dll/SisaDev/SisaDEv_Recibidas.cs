...
// Type: SisaDev.SisaDEv_Recibidas
...
namespace SisaDev
{
  ...
  [XmlRoot("SisaDEv_Recibidas")]
  [HelpKeyword("vs.data.DataSet")]
  [Serializable]
  public class SisaDEv_Recibidas : DataSet
  {
    private SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable tablesp_CargarFacturasRecibidas;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected SisaDEv_Recibidas(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (sp_CargarFacturasRecibidas)] != null)
            base.Tables.Add((DataTable) new SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable(dataSet.Tables[nameof (sp_CargarFacturasRecibidas)]));
    ...
    public SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable sp_CargarFacturasRecibidas => this.tablesp_CargarFacturasRecibidas;
    ...
    {
      SisaDEv_Recibidas sisaDevRecibidas = (SisaDEv_Recibidas) base.Clone();
      sisaDevRecibidas.InitVars();
      sisaDevRecibidas.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) sisaDevRecibidas;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["sp_CargarFacturasRecibidas"] != null)
          base.Tables.Add((DataTable) new SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable(dataSet.Tables["sp_CargarFacturasRecibidas"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tablesp_CargarFacturasRecibidas = (SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable) base.Tables["sp_CargarFacturasRecibidas"];
    ...
    {
      this.DataSetName = nameof (SisaDEv_Recibidas);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/SisaDEv_Recibidas.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tablesp_CargarFacturasRecibidas = new SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable();
    ...
    {
      SisaDEv_Recibidas sisaDevRecibidas = new SisaDEv_Recibidas();
      XmlSchemaComplexType schemaComplexType = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = sisaDevRecibidas.Namespace
      });
      schemaComplexType.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = sisaDevRecibidas.GetSchemaSerializable();
    ...
    public delegate void sp_CargarFacturasRecibidasRowChangeEventHandler(
      object sender,
      SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class sp_CargarFacturasRecibidasDataTable : 
      TypedTableBase<SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow this[int index] => (SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEventHandler sp_CargarFacturasRecibidasRowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEventHandler sp_CargarFacturasRecibidasRowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEventHandler sp_CargarFacturasRecibidasRowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEventHandler sp_CargarFacturasRecibidasRowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void Addsp_CargarFacturasRecibidasRow(
        SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow row)
      {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow Addsp_CargarFacturasRecibidasRow(
        ...
        Decimal APagar)
      {
        SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow facturasRecibidasRow = (SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) this.NewRow();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow FindByIdControlFacturas(
        Guid IdControlFacturas)
      {
        return (SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) this.Rows.Find(new object[1]
        {
          (object) IdControlFacturas
        });
      }
      ...
      {
        SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable recibidasDataTable = (SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow Newsp_CargarFacturasRecibidasRow() => (SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_CargarFacturasRecibidasRowChanged == null)
          return;
        this.sp_CargarFacturasRecibidasRowChanged((object) this, new SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEvent((SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_CargarFacturasRecibidasRowChanging == null)
          return;
        this.sp_CargarFacturasRecibidasRowChanging((object) this, new SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEvent((SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_CargarFacturasRecibidasRowDeleted == null)
          return;
        this.sp_CargarFacturasRecibidasRowDeleted((object) this, new SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEvent((SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_CargarFacturasRecibidasRowDeleting == null)
          return;
        this.sp_CargarFacturasRecibidasRowDeleting((object) this, new SisaDEv_Recibidas.sp_CargarFacturasRecibidasRowChangeEvent((SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow) e.Row, e.Action));
      }
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = sisaDevRecibidas.Namespace
        });
        schemaComplexType.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class sp_CargarFacturasRecibidasRow : DataRow
    {
      ...
      internal sp_CargarFacturasRecibidasRow(DataRowBuilder rb)
        : base(rb)
      {
        this.tablesp_CargarFacturasRecibidas = (SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable) this.Table;
      }
    ...
    {
      private SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow eventRow;
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDEv_Recibidas.sp_CargarFacturasRecibidasRow Row => this.eventRow;
