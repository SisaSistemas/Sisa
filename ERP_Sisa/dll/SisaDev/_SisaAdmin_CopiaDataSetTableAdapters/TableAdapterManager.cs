...
// Type: SisaDev._SisaAdmin_CopiaDataSetTableAdapters.TableAdapterManager
...
namespace SisaDev._SisaAdmin_CopiaDataSetTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private int UpdateUpdatedRows(
      _SisaAdmin_CopiaDataSet dataSet,
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(_SisaAdmin_CopiaDataSet dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(_SisaAdmin_CopiaDataSet dataSet, List<DataRow> allChangedRows) => 0;
