...
// Type: SisaDev.SisaDevFacturasTableAdapters.tblProyectoTaskImagenTableAdapter
...
namespace SisaDev.SisaDevFacturasTableAdapters
{
  ...
  public class tblProyectoTaskImagenTableAdapter : Component
  {
    ...
    public tblProyectoTaskImagenTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "tblProyectoTaskImagen",
        ColumnMappings = {
          {
            "IdTaskImagen",
            "IdTaskImagen"
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblProyectoTaskImagen] WHERE (([IdTaskImagen] = @Original_IdTaskImagen))";
      this._adapter.DeleteCommand.CommandType = CommandType.Text;
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_IdTaskImagen", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdTaskImagen", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.InsertCommand = new SqlCommand();
      this._adapter.InsertCommand.Connection = this.Connection;
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblProyectoTaskImagen] ([IdTaskImagen], [IdTask], [Imagen], [Descripcion], [FileName], [FileExtension], [FileSize], [FileContentType], [Fecha], [IdUsuario]) VALUES (@IdTaskImagen, @IdTask, @Imagen, @Descripcion, @FileName, @FileExtension, @FileSize, @FileContentType, @Fecha, @IdUsuario)";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IdTaskImagen", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdTaskImagen", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblProyectoTaskImagen] SET [IdTaskImagen] = @IdTaskImagen, [IdTask] = @IdTask, [Imagen] = @Imagen, [Descripcion] = @Descripcion, [FileName] = @FileName, [FileExtension] = @FileExtension, [FileSize] = @FileSize, [FileContentType] = @FileContentType, [Fecha] = @Fecha, [IdUsuario] = @IdUsuario WHERE (([IdTaskImagen] = @Original_IdTaskImagen))";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IdTaskImagen", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdTaskImagen", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_IdTaskImagen", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdTaskImagen", DataRowVersion.Original, false, (object) null, "", "", ""));
    }
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT IdTaskImagen, IdTask, Imagen, Descripcion, FileName, FileExtension, FileSize, FileContentType, Fecha, IdUsuario FROM dbo.tblProyectoTaskImagen";
    ...
    public virtual int Fill(
      SisaDevFacturas.tblProyectoTaskImagenDataTable dataTable)
    {
    ...
    public virtual SisaDevFacturas.tblProyectoTaskImagenDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDevFacturas.tblProyectoTaskImagenDataTable taskImagenDataTable = new SisaDevFacturas.tblProyectoTaskImagenDataTable();
      this.Adapter.Fill((DataTable) taskImagenDataTable);
      return taskImagenDataTable;
    }
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas dataSet) => this.Adapter.Update((DataSet) dataSet, "tblProyectoTaskImagen");
    ...
    public virtual int Delete(Guid Original_IdTaskImagen)
    {
      this.Adapter.DeleteCommand.Parameters[0].Value = (object) Original_IdTaskImagen;
    ...
    public virtual int Insert(
      ...
      Guid IdUsuario)
    {
      this.Adapter.InsertCommand.Parameters[0].Value = (object) IdTaskImagen;
      this.Adapter.InsertCommand.Parameters[1].Value = (object) IdTask;
      ...
      this.Adapter.InsertCommand.Parameters[4].Value = FileName != null ? (object) FileName : throw new ArgumentNullException(nameof (FileName));
      this.Adapter.InsertCommand.Parameters[5].Value = FileExtension != null ? (object) FileExtension : throw new ArgumentNullException(nameof (FileExtension));
      this.Adapter.InsertCommand.Parameters[6].Value = FileSize != null ? (object) FileSize : throw new ArgumentNullException(nameof (FileSize));
      this.Adapter.InsertCommand.Parameters[7].Value = FileContentType != null ? (object) FileContentType : throw new ArgumentNullException(nameof (FileContentType));
    ...
    public virtual int Update(
      ...
      DateTime Fecha,
      Guid IdUsuario,
      Guid Original_IdTaskImagen)
    {
      this.Adapter.UpdateCommand.Parameters[0].Value = (object) IdTaskImagen;
      this.Adapter.UpdateCommand.Parameters[1].Value = (object) IdTask;
      ...
      this.Adapter.UpdateCommand.Parameters[4].Value = FileName != null ? (object) FileName : throw new ArgumentNullException(nameof (FileName));
      this.Adapter.UpdateCommand.Parameters[5].Value = FileExtension != null ? (object) FileExtension : throw new ArgumentNullException(nameof (FileExtension));
      this.Adapter.UpdateCommand.Parameters[6].Value = FileSize != null ? (object) FileSize : throw new ArgumentNullException(nameof (FileSize));
      this.Adapter.UpdateCommand.Parameters[7].Value = FileContentType != null ? (object) FileContentType : throw new ArgumentNullException(nameof (FileContentType));
      this.Adapter.UpdateCommand.Parameters[8].Value = (object) Fecha;
      this.Adapter.UpdateCommand.Parameters[9].Value = (object) IdUsuario;
      this.Adapter.UpdateCommand.Parameters[10].Value = (object) Original_IdTaskImagen;
    ...
    public virtual int Update(
      ...
      Guid Original_IdTaskImagen)
    {
      return this.Update(Original_IdTaskImagen, IdTask, Imagen, Descripcion, FileName, FileExtension, FileSize, FileContentType, Fecha, IdUsuario, Original_IdTaskImagen);
    }
  }
}
