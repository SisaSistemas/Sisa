...
// Type: SisaDev.SisaDevFacturasTableAdapters.tblInventarioTableAdapter
...
namespace SisaDev.SisaDevFacturasTableAdapters
{
  ...
  public class tblInventarioTableAdapter : Component
  {
    ...
    public tblInventarioTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblInventario] WHERE (([IdHerramienta] = @Original_IdHerramienta))";
      this._adapter.DeleteCommand.CommandType = CommandType.Text;
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_IdHerramienta", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdHerramienta", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.InsertCommand = new SqlCommand();
      this._adapter.InsertCommand.Connection = this.Connection;
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblInventario] ([NoCodigo], [Descripcion], [Tipo], [NoSerie], [Observaciones], [Contenedor], [Estatus], [Entradas], [Salidas], [TotalAlmacen]) VALUES (@NoCodigo, @Descripcion, @Tipo, @NoSerie, @Observaciones, @Contenedor, @Estatus, @Entradas, @Salidas, @TotalAlmacen)";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblInventario] SET [NoCodigo] = @NoCodigo, [Descripcion] = @Descripcion, [Tipo] = @Tipo, [NoSerie] = @NoSerie, [Observaciones] = @Observaciones, [Contenedor] = @Contenedor, [Estatus] = @Estatus, [Entradas] = @Entradas, [Salidas] = @Salidas, [TotalAlmacen] = @TotalAlmacen WHERE (([IdHerramienta] = @Original_IdHerramienta))";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_IdHerramienta", SqlDbType.Int, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdHerramienta", DataRowVersion.Original, false, (object) null, "", "", ""));
    }
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT IdHerramienta, NoCodigo, Descripcion, Tipo, NoSerie, Observaciones, Contenedor, Estatus, Entradas, Salidas, TotalAlmacen FROM dbo.tblInventario";
    ...
    public virtual int Fill(SisaDevFacturas.tblInventarioDataTable dataTable)
    {
    ...
    public virtual SisaDevFacturas.tblInventarioDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDevFacturas.tblInventarioDataTable inventarioDataTable = new SisaDevFacturas.tblInventarioDataTable();
      this.Adapter.Fill((DataTable) inventarioDataTable);
      return inventarioDataTable;
    }

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas.tblInventarioDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas dataSet) => this.Adapter.Update((DataSet) dataSet, "tblInventario");
    ...
    public virtual int Delete(int Original_IdHerramienta)
    {
    ...
    {
      this.Adapter.InsertCommand.Parameters[0].Value = NoCodigo != null ? (object) NoCodigo : throw new ArgumentNullException(nameof (NoCodigo));
      ...
      this.Adapter.InsertCommand.Parameters[3].Value = NoSerie != null ? (object) NoSerie : throw new ArgumentNullException(nameof (NoSerie));
      this.Adapter.InsertCommand.Parameters[4].Value = Observaciones != null ? (object) Observaciones : throw new ArgumentNullException(nameof (Observaciones));
      this.Adapter.InsertCommand.Parameters[5].Value = (object) Contenedor;
      this.Adapter.InsertCommand.Parameters[6].Value = (object) Estatus;
      this.Adapter.InsertCommand.Parameters[7].Value = (object) Entradas;
      this.Adapter.InsertCommand.Parameters[8].Value = (object) Salidas;
      this.Adapter.InsertCommand.Parameters[9].Value = (object) TotalAlmacen;
    ...
    public virtual int Update(
      ...
      Decimal Salidas,
      Decimal TotalAlmacen,
      int Original_IdHerramienta)
    {
      this.Adapter.UpdateCommand.Parameters[0].Value = NoCodigo != null ? (object) NoCodigo : throw new ArgumentNullException(nameof (NoCodigo));
      ...
      this.Adapter.UpdateCommand.Parameters[3].Value = NoSerie != null ? (object) NoSerie : throw new ArgumentNullException(nameof (NoSerie));
      this.Adapter.UpdateCommand.Parameters[4].Value = Observaciones != null ? (object) Observaciones : throw new ArgumentNullException(nameof (Observaciones));
      this.Adapter.UpdateCommand.Parameters[5].Value = (object) Contenedor;
      this.Adapter.UpdateCommand.Parameters[6].Value = (object) Estatus;
      this.Adapter.UpdateCommand.Parameters[7].Value = (object) Entradas;
      this.Adapter.UpdateCommand.Parameters[8].Value = (object) Salidas;
      this.Adapter.UpdateCommand.Parameters[9].Value = (object) TotalAlmacen;
      this.Adapter.UpdateCommand.Parameters[10].Value = (object) Original_IdHerramienta;
