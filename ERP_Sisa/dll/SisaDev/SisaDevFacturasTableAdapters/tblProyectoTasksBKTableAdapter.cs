...
// Type: SisaDev.SisaDevFacturasTableAdapters.tblProyectoTasksBKTableAdapter
...
namespace SisaDev.SisaDevFacturasTableAdapters
{
  ...
  public class tblProyectoTasksBKTableAdapter : Component
  {
    ...
    public tblProyectoTasksBKTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "tblProyectoTasksBK",
        ColumnMappings = {
          {
            "IdTask",
            "IdTask"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblProyectoTasksBK] ([ID], [IdProyecto], [Task], [IdUsuario], [FechaInicio], [FechaFin], [Comentarios], [Estatus], [IdUsuarioAlta], [FechaAlta], [IdUsuarioModificacion], [FechaModificacion], [Porcentaje]) VALUES (@ID, @IdProyecto, @Task, @IdUsuario, @FechaInicio, @FechaFin, @Comentarios, @Estatus, @IdUsuarioAlta, @FechaAlta, @IdUsuarioModificacion, @FechaModificacion, @Porcentaje)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT IdTask, ID, IdProyecto, Task, IdUsuario, FechaInicio, FechaFin, Comentarios, Estatus, IdUsuarioAlta, FechaAlta, IdUsuarioModificacion, FechaModificacion, Porcentaje FROM dbo.tblProyectoTasksBK";
    ...
    public virtual int Fill(
      SisaDevFacturas.tblProyectoTasksBKDataTable dataTable)
    {
    ...
    public virtual SisaDevFacturas.tblProyectoTasksBKDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDevFacturas.tblProyectoTasksBKDataTable tasksBkDataTable = new SisaDevFacturas.tblProyectoTasksBKDataTable();
      this.Adapter.Fill((DataTable) tasksBkDataTable);
      return tasksBkDataTable;
    }
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas dataSet) => this.Adapter.Update((DataSet) dataSet, "tblProyectoTasksBK");
