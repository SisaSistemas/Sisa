...
// Type: SisaDev.SisaDevFacturasTableAdapters.tblReqDetTableAdapter
...
namespace SisaDev.SisaDevFacturasTableAdapters
{
  ...
  public class tblReqDetTableAdapter : Component
  {
    ...
    public tblReqDetTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblReqDet] WHERE (([IdReqDet] = @Original_IdReqDet))";
      this._adapter.DeleteCommand.CommandType = CommandType.Text;
      this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_IdReqDet", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdReqDet", DataRowVersion.Original, false, (object) null, "", "", ""));
      this._adapter.InsertCommand = new SqlCommand();
      this._adapter.InsertCommand.Connection = this.Connection;
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblReqDet] ([IdReqDet], [IdReqEnc], [Item], [Descripcion], [Cantidad], [Unidad], [NumeroParte], [Marca], [Estatus], [TimeStamp]) VALUES (@IdReqDet, @IdReqEnc, @Item, @Descripcion, @Cantidad, @Unidad, @NumeroParte, @Marca, @Estatus, @TimeStamp)";
      this._adapter.InsertCommand.CommandType = CommandType.Text;
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@IdReqDet", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdReqDet", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblReqDet] SET [IdReqDet] = @IdReqDet, [IdReqEnc] = @IdReqEnc, [Item] = @Item, [Descripcion] = @Descripcion, [Cantidad] = @Cantidad, [Unidad] = @Unidad, [NumeroParte] = @NumeroParte, [Marca] = @Marca, [Estatus] = @Estatus, [TimeStamp] = @TimeStamp WHERE (([IdReqDet] = @Original_IdReqDet))";
      this._adapter.UpdateCommand.CommandType = CommandType.Text;
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IdReqDet", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdReqDet", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_IdReqDet", SqlDbType.UniqueIdentifier, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "IdReqDet", DataRowVersion.Original, false, (object) null, "", "", ""));
    }
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT IdReqDet, IdReqEnc, Item, Descripcion, Cantidad, Unidad, NumeroParte, Marca, Estatus, TimeStamp FROM dbo.tblReqDet";
    ...
    public virtual int Fill(SisaDevFacturas.tblReqDetDataTable dataTable)
    {
    ...
    public virtual SisaDevFacturas.tblReqDetDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDevFacturas.tblReqDetDataTable tblReqDetDataTable = new SisaDevFacturas.tblReqDetDataTable();
      this.Adapter.Fill((DataTable) tblReqDetDataTable);
      return tblReqDetDataTable;
    }

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas.tblReqDetDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas dataSet) => this.Adapter.Update((DataSet) dataSet, "tblReqDet");
    ...
    public virtual int Delete(Guid Original_IdReqDet)
    {
      this.Adapter.DeleteCommand.Parameters[0].Value = (object) Original_IdReqDet;
    ...
    public virtual int Insert(
      ...
      DateTime? TimeStamp)
    {
      this.Adapter.InsertCommand.Parameters[0].Value = (object) IdReqDet;
      this.Adapter.InsertCommand.Parameters[1].Value = (object) IdReqEnc;
    ...
    public virtual int Update(
      ...
      bool? Estatus,
      DateTime? TimeStamp,
      Guid Original_IdReqDet)
    {
      this.Adapter.UpdateCommand.Parameters[0].Value = (object) IdReqDet;
      this.Adapter.UpdateCommand.Parameters[1].Value = (object) IdReqEnc;
      ...
      this.Adapter.UpdateCommand.Parameters[10].Value = (object) Original_IdReqDet;
    ...
    public virtual int Update(
      ...
      Guid Original_IdReqDet)
    {
      return this.Update(Original_IdReqDet, IdReqEnc, Item, Descripcion, Cantidad, Unidad, NumeroParte, Marca, Estatus, TimeStamp, Original_IdReqDet);
    }
  }
}
