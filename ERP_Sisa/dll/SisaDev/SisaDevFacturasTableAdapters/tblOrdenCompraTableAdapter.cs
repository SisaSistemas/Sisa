...
// Type: SisaDev.SisaDevFacturasTableAdapters.tblOrdenCompraTableAdapter
...
namespace SisaDev.SisaDevFacturasTableAdapters
{
  ...
  public class tblOrdenCompraTableAdapter : Component
  {
    ...
    public tblOrdenCompraTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tblOrdenCompra] WHERE (([IdOrdenCompra] = @Original_IdOrdenCompra))";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblOrdenCompra] ([IdOrdenCompra], [Folio], [IdProveedor], [ReferenciaCot], [IdProyecto], [IdUsuario], [SubTotal], [Iva], [Estatus], [Enviada], [EnviarA], [IdMoneda], [CondicionPago], [Comentarios], [FechaCreacion], [IdUsuarioCreacion], [FechaModificacion], [IdUsuarioModificacion], [FechaCancelacion], [IdUsuarioCancelacion], [MotivoCancelacion], [Descuento], [IdUsuarioAprobo], [TipoOC], [idSucursal], [idRequisicion], [FolioReq]) VALUES (@IdOrdenCompra, @Folio, @IdProveedor, @ReferenciaCot, @IdProyecto, @IdUsuario, @SubTotal, @Iva, @Estatus, @Enviada, @EnviarA, @IdMoneda, @CondicionPago, @Comentarios, @FechaCreacion, @IdUsuarioCreacion, @FechaModificacion, @IdUsuarioModificacion, @FechaCancelacion, @IdUsuarioCancelacion, @MotivoCancelacion, @Descuento, @IdUsuarioAprobo, @TipoOC, @idSucursal, @idRequisicion, @FolioReq)";
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@TipoOC", SqlDbType.VarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "TipoOC", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@FolioReq", SqlDbType.VarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "FolioReq", DataRowVersion.Current, false, (object) null, "", "", ""));
      this._adapter.UpdateCommand = new SqlCommand();
      this._adapter.UpdateCommand.Connection = this.Connection;
      this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblOrdenCompra] SET [IdOrdenCompra] = @IdOrdenCompra, [Folio] = @Folio, [IdProveedor] = @IdProveedor, [ReferenciaCot] = @ReferenciaCot, [IdProyecto] = @IdProyecto, [IdUsuario] = @IdUsuario, [SubTotal] = @SubTotal, [Iva] = @Iva, [Estatus] = @Estatus, [Enviada] = @Enviada, [EnviarA] = @EnviarA, [IdMoneda] = @IdMoneda, [CondicionPago] = @CondicionPago, [Comentarios] = @Comentarios, [FechaCreacion] = @FechaCreacion, [IdUsuarioCreacion] = @IdUsuarioCreacion, [FechaModificacion] = @FechaModificacion, [IdUsuarioModificacion] = @IdUsuarioModificacion, [FechaCancelacion] = @FechaCancelacion, [IdUsuarioCancelacion] = @IdUsuarioCancelacion, [MotivoCancelacion] = @MotivoCancelacion, [Descuento] = @Descuento, [IdUsuarioAprobo] = @IdUsuarioAprobo, [TipoOC] = @TipoOC, [idSucursal] = @idSucursal, [idRequisicion] = @idRequisicion, [FolioReq] = @FolioReq WHERE (([IdOrdenCompra] = @Original_IdOrdenCompra))";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@TipoOC", SqlDbType.VarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "TipoOC", DataRowVersion.Current, false, (object) null, "", "", ""));
      ...
      this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@FolioReq", SqlDbType.VarChar, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "FolioReq", DataRowVersion.Current, false, (object) null, "", "", ""));
    ...
    public virtual int Fill(SisaDevFacturas.tblOrdenCompraDataTable dataTable)
    {
    ...
    public virtual SisaDevFacturas.tblOrdenCompraDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDevFacturas.tblOrdenCompraDataTable ordenCompraDataTable = new SisaDevFacturas.tblOrdenCompraDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas.tblOrdenCompraDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas dataSet) => this.Adapter.Update((DataSet) dataSet, "tblOrdenCompra");
      ...
      string FolioReq)
    {
      ...
      this.Adapter.InsertCommand.Parameters[4].Value = (object) IdProyecto;
      ...
      if (TipoOC == null)
        ...
        this.Adapter.InsertCommand.Parameters[23].Value = (object) TipoOC;
      if (idSucursal.HasValue)
        this.Adapter.InsertCommand.Parameters[24].Value = (object) idSucursal.Value;
      else
        this.Adapter.InsertCommand.Parameters[24].Value = (object) DBNull.Value;
      if (idRequisicion.HasValue)
        this.Adapter.InsertCommand.Parameters[25].Value = (object) idRequisicion.Value;
      else
      ...
      if (FolioReq == null)
        ...
        this.Adapter.InsertCommand.Parameters[26].Value = (object) FolioReq;
      ...
      Guid Original_IdOrdenCompra)
    {
      ...
      this.Adapter.UpdateCommand.Parameters[4].Value = (object) IdProyecto;
      ...
      if (TipoOC == null)
        ...
        this.Adapter.UpdateCommand.Parameters[23].Value = (object) TipoOC;
      if (idSucursal.HasValue)
        this.Adapter.UpdateCommand.Parameters[24].Value = (object) idSucursal.Value;
      else
        this.Adapter.UpdateCommand.Parameters[24].Value = (object) DBNull.Value;
      if (idRequisicion.HasValue)
        this.Adapter.UpdateCommand.Parameters[25].Value = (object) idRequisicion.Value;
      else
      ...
      if (FolioReq == null)
        ...
        this.Adapter.UpdateCommand.Parameters[26].Value = (object) FolioReq;
      this.Adapter.UpdateCommand.Parameters[27].Value = (object) Original_IdOrdenCompra;
