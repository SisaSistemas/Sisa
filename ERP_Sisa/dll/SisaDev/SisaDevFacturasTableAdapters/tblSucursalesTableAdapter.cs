...
// Type: SisaDev.SisaDevFacturasTableAdapters.tblSucursalesTableAdapter
...
namespace SisaDev.SisaDevFacturasTableAdapters
{
  ...
  public class tblSucursalesTableAdapter : Component
  {
    ...
    public virtual int Fill(SisaDevFacturas.tblSucursalesDataTable dataTable)
    {
    ...
    public virtual SisaDevFacturas.tblSucursalesDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDevFacturas.tblSucursalesDataTable sucursalesDataTable = new SisaDevFacturas.tblSucursalesDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas.tblSucursalesDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDevFacturas dataSet) => this.Adapter.Update((DataSet) dataSet, "tblSucursales");
