...
// Type: SisaDev.SisaDEv_RecibidasTableAdapters.sp_CargarFacturasRecibidasTableAdapter
...
namespace SisaDev.SisaDEv_RecibidasTableAdapters
{
  ...
  public class sp_CargarFacturasRecibidasTableAdapter : Component
  {
    ...
    public virtual int Fill(
      SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable dataTable,
      string id)
    {
    ...
    public virtual SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable GetData(
      string id)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (id == null)
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) id;
      SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable recibidasDataTable = new SisaDEv_Recibidas.sp_CargarFacturasRecibidasDataTable();
