...
// Type: SisaDev.Rpt.SisaTableAdapters.sp_LoadProyectoTasksTableAdapter
...
namespace SisaDev.Rpt.SisaTableAdapters
{
  ...
  public class sp_LoadProyectoTasksTableAdapter : Component
  {
    ...
    public sp_LoadProyectoTasksTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "sp_LoadProyectoTasks",
        ColumnMappings = {
          {
            "IdProyecto",
            "IdProyecto"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.sp_LoadProyectoTasks";
    ...
    public virtual int Fill(Sisa.sp_LoadProyectoTasksDataTable dataTable, string IdProyecto)
    {
    ...
    public virtual Sisa.sp_LoadProyectoTasksDataTable GetData(string IdProyecto)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (IdProyecto == null)
        this.Adapter.SelectCommand.Parameters[1].Value = (object) DBNull.Value;
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) IdProyecto;
      Sisa.sp_LoadProyectoTasksDataTable proyectoTasksDataTable = new Sisa.sp_LoadProyectoTasksDataTable();
