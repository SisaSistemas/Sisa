...
// Type: SisaDev.Rpt.SisaTableAdapters.sp_InsertViaticosTableAdapter
...
namespace SisaDev.Rpt.SisaTableAdapters
{
  ...
  public class sp_InsertViaticosTableAdapter : Component
  {
    ...
    public sp_InsertViaticosTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "sp_InsertViaticos",
        ColumnMappings = {
          {
            "IdViaticos",
            "IdViaticos"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.sp_InsertViaticos";
      ...
      this._commandCollection[0].Parameters.Add(new SqlParameter("@CantEntregada", SqlDbType.Decimal, 9, ParameterDirection.Input, (byte) 18, (byte) 2, (string) null, DataRowVersion.Current, false, (object) null, "", "", ""));
    ...
    public virtual int Fill(
      Sisa.sp_InsertViaticosDataTable dataTable,
      string IdProyecto,
      ...
      string IdUsuario)
    {
      ...
      if (CantEntregada.HasValue)
        this.Adapter.SelectCommand.Parameters[2].Value = (object) CantEntregada.Value;
      else
      ...
      if (IdUsuario == null)
        ...
        this.Adapter.SelectCommand.Parameters[3].Value = (object) IdUsuario;
    ...
    public virtual Sisa.sp_InsertViaticosDataTable GetData(
      string IdProyecto,
      Decimal? CantEntregada,
      string IdUsuario)
    {
      ...
      if (IdUsuario == null)
        ...
        this.Adapter.SelectCommand.Parameters[3].Value = (object) IdUsuario;
      Sisa.sp_InsertViaticosDataTable viaticosDataTable = new Sisa.sp_InsertViaticosDataTable();
