...
// Type: SisaDev.Rpt.SisaTableAdapters.sp_GeneraReporteValiantTableAdapter
...
namespace SisaDev.Rpt.SisaTableAdapters
{
  ...
  public class sp_GeneraReporteValiantTableAdapter : Component
  {
    ...
    public sp_GeneraReporteValiantTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "sp_GeneraReporteValiant",
        ColumnMappings = {
          {
            "IdEstacionValiant",
            "IdEstacionValiant"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.sp_GeneraReporteValiant";
    ...
    public virtual int Fill(Sisa.sp_GeneraReporteValiantDataTable dataTable, int? IdEstacion)
    {
    ...
    public virtual Sisa.sp_GeneraReporteValiantDataTable GetData(int? IdEstacion)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (IdEstacion.HasValue)
        this.Adapter.SelectCommand.Parameters[1].Value = (object) IdEstacion.Value;
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) DBNull.Value;
      Sisa.sp_GeneraReporteValiantDataTable valiantDataTable = new Sisa.sp_GeneraReporteValiantDataTable();
      this.Adapter.Fill((DataTable) valiantDataTable);
      return valiantDataTable;
    }
  }
}
