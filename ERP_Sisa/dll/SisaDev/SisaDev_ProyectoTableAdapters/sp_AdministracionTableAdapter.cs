...
// Type: SisaDev.SisaDev_ProyectoTableAdapters.sp_AdministracionTableAdapter
...
namespace SisaDev.SisaDev_ProyectoTableAdapters
{
  ...
  public class sp_AdministracionTableAdapter : Component
  {
    ...
    public virtual int Fill(
      SisaDev_Proyecto.sp_AdministracionDataTable dataTable)
    {
    ...
    public virtual SisaDev_Proyecto.sp_AdministracionDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDev_Proyecto.sp_AdministracionDataTable administracionDataTable = new SisaDev_Proyecto.sp_AdministracionDataTable();
