...
namespace SisaDev
{
  ...
  [Serializable]
  public class SisaDev_OC : DataSet
  {
    private SisaDev_OC.sp_LoadOrdenCompraDataTable tablesp_LoadOrdenCompra;
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    protected SisaDev_OC(SerializationInfo info, StreamingContext context)
      ...
      else
      {
        ...
        if (this.DetermineSchemaSerializationMode(info, context) == SchemaSerializationMode.IncludeSchema)
        {
          ...
          if (dataSet.Tables[nameof (sp_LoadOrdenCompra)] != null)
            base.Tables.Add((DataTable) new SisaDev_OC.sp_LoadOrdenCompraDataTable(dataSet.Tables[nameof (sp_LoadOrdenCompra)]));
    ...
    public SisaDev_OC.sp_LoadOrdenCompraDataTable sp_LoadOrdenCompra => this.tablesp_LoadOrdenCompra;
    ...
    {
      SisaDev_OC sisaDevOc = (SisaDev_OC) base.Clone();
      sisaDevOc.InitVars();
      sisaDevOc.SchemaSerializationMode = this.SchemaSerializationMode;
      return (DataSet) sisaDevOc;
    }
    ...
    protected override void ReadXmlSerializable(XmlReader reader)
    {
      if (this.DetermineSchemaSerializationMode(reader) == SchemaSerializationMode.IncludeSchema)
      {
        ...
        if (dataSet.Tables["sp_LoadOrdenCompra"] != null)
          base.Tables.Add((DataTable) new SisaDev_OC.sp_LoadOrdenCompraDataTable(dataSet.Tables["sp_LoadOrdenCompra"]));
        this.DataSetName = dataSet.DataSetName;
        this.Prefix = dataSet.Prefix;
        this.Namespace = dataSet.Namespace;
        this.Locale = dataSet.Locale;
    ...
    {
      this.tablesp_LoadOrdenCompra = (SisaDev_OC.sp_LoadOrdenCompraDataTable) base.Tables["sp_LoadOrdenCompra"];
    ...
    {
      this.DataSetName = nameof (SisaDev_OC);
      this.Prefix = "";
      this.Namespace = "http://tempuri.org/SisaDev_OC.xsd";
      this.EnforceConstraints = true;
      this.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
      this.tablesp_LoadOrdenCompra = new SisaDev_OC.sp_LoadOrdenCompraDataTable();
    ...
    {
      SisaDev_OC sisaDevOc = new SisaDev_OC();
      XmlSchemaComplexType schemaComplexType = new XmlSchemaComplexType();
      XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
      xmlSchemaSequence.Items.Add((XmlSchemaObject) new XmlSchemaAny()
      {
        Namespace = sisaDevOc.Namespace
      });
      schemaComplexType.Particle = (XmlSchemaParticle) xmlSchemaSequence;
      XmlSchema schemaSerializable = sisaDevOc.GetSchemaSerializable();
    ...
    public delegate void sp_LoadOrdenCompraRowChangeEventHandler(
      object sender,
      SisaDev_OC.sp_LoadOrdenCompraRowChangeEvent e);

    [XmlSchemaProvider("GetTypedTableSchema")]
    [Serializable]
    public class sp_LoadOrdenCompraDataTable : TypedTableBase<SisaDev_OC.sp_LoadOrdenCompraRow>
    {
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_OC.sp_LoadOrdenCompraRow this[int index] => (SisaDev_OC.sp_LoadOrdenCompraRow) this.Rows[index];

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_OC.sp_LoadOrdenCompraRowChangeEventHandler sp_LoadOrdenCompraRowChanging;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_OC.sp_LoadOrdenCompraRowChangeEventHandler sp_LoadOrdenCompraRowChanged;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_OC.sp_LoadOrdenCompraRowChangeEventHandler sp_LoadOrdenCompraRowDeleting;

      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public event SisaDev_OC.sp_LoadOrdenCompraRowChangeEventHandler sp_LoadOrdenCompraRowDeleted;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void Addsp_LoadOrdenCompraRow(SisaDev_OC.sp_LoadOrdenCompraRow row) => this.Rows.Add((DataRow) row);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_OC.sp_LoadOrdenCompraRow Addsp_LoadOrdenCompraRow(
        Guid IdOrdenCompra,
        string Folio,
        string Proveedor,
      ...
      {
        SisaDev_OC.sp_LoadOrdenCompraRow loadOrdenCompraRow = (SisaDev_OC.sp_LoadOrdenCompraRow) this.NewRow();
      ...
      {
        SisaDev_OC.sp_LoadOrdenCompraDataTable ordenCompraDataTable = (SisaDev_OC.sp_LoadOrdenCompraDataTable) base.Clone();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataTable CreateInstance() => (DataTable) new SisaDev_OC.sp_LoadOrdenCompraDataTable();
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_OC.sp_LoadOrdenCompraRow Newsp_LoadOrdenCompraRow() => (SisaDev_OC.sp_LoadOrdenCompraRow) this.NewRow();

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override DataRow NewRowFromBuilder(DataRowBuilder builder) => (DataRow) new SisaDev_OC.sp_LoadOrdenCompraRow(builder);

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      protected override Type GetRowType() => typeof (SisaDev_OC.sp_LoadOrdenCompraRow);
      ...
      protected override void OnRowChanged(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_LoadOrdenCompraRowChanged == null)
          return;
        this.sp_LoadOrdenCompraRowChanged((object) this, new SisaDev_OC.sp_LoadOrdenCompraRowChangeEvent((SisaDev_OC.sp_LoadOrdenCompraRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowChanging(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_LoadOrdenCompraRowChanging == null)
          return;
        this.sp_LoadOrdenCompraRowChanging((object) this, new SisaDev_OC.sp_LoadOrdenCompraRowChangeEvent((SisaDev_OC.sp_LoadOrdenCompraRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleted(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_LoadOrdenCompraRowDeleted == null)
          return;
        this.sp_LoadOrdenCompraRowDeleted((object) this, new SisaDev_OC.sp_LoadOrdenCompraRowChangeEvent((SisaDev_OC.sp_LoadOrdenCompraRow) e.Row, e.Action));
      }
      ...
      protected override void OnRowDeleting(DataRowChangeEventArgs e)
      {
        ...
        if (this.sp_LoadOrdenCompraRowDeleting == null)
          return;
        this.sp_LoadOrdenCompraRowDeleting((object) this, new SisaDev_OC.sp_LoadOrdenCompraRowChangeEvent((SisaDev_OC.sp_LoadOrdenCompraRow) e.Row, e.Action));
      }

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public void Removesp_LoadOrdenCompraRow(SisaDev_OC.sp_LoadOrdenCompraRow row) => this.Rows.Remove((DataRow) row);
      ...
      public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
      {
        ...
        {
          Name = "namespace",
          FixedValue = sisaDevOc.Namespace
        });
        schemaComplexType.Attributes.Add((XmlSchemaObject) new XmlSchemaAttribute()
        {
          Name = "tableTypeName",
    ...
    public class sp_LoadOrdenCompraRow : DataRow
    {
      ...
      internal sp_LoadOrdenCompraRow(DataRowBuilder rb)
        : base(rb)
      {
        this.tablesp_LoadOrdenCompra = (SisaDev_OC.sp_LoadOrdenCompraDataTable) this.Table;
      }
    ...
    {
      private SisaDev_OC.sp_LoadOrdenCompraRow eventRow;
      private DataRowAction eventAction;

      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public sp_LoadOrdenCompraRowChangeEvent(
        SisaDev_OC.sp_LoadOrdenCompraRow row,
      ...
      [DebuggerNonUserCode]
      [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
      public SisaDev_OC.sp_LoadOrdenCompraRow Row => this.eventRow;
