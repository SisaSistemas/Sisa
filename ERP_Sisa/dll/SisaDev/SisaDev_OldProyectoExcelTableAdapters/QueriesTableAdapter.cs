...
// Type: SisaDev.SisaDev_OldProyectoExcelTableAdapters.QueriesTableAdapter
...
namespace SisaDev.SisaDev_OldProyectoExcelTableAdapters
{
  ...
  public class QueriesTableAdapter : Component
  {
    ...
    private void InitCommandCollection()
    {
      ...
      ((DbCommand) this._commandCollection[0]).CommandText = "dbo.sp_BDExcelRober";
