...
// Type: SisaDev.SisaDev_UsuarioTableAdapters.tblUsuariosTableAdapter
...
namespace SisaDev.SisaDev_UsuarioTableAdapters
{
  ...
  public class tblUsuariosTableAdapter : Component
  {
    ...
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SisaDev_Usuario.tblUsuariosDataTable usuariosDataTable = new SisaDev_Usuario.tblUsuariosDataTable();
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDev_Usuario.tblUsuariosDataTable dataTable) => this.Adapter.Update((DataTable) dataTable);

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SisaDev_Usuario dataSet) => this.Adapter.Update((DataSet) dataSet, "tblUsuarios");
