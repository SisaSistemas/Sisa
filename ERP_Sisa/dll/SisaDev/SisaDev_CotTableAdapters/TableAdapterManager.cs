...
// Type: SisaDev.SisaDev_CotTableAdapters.TableAdapterManager
...
namespace SisaDev.SisaDev_CotTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateInsertedRows(SisaDev_Cot dataSet, List<DataRow> allAddedRows) => 0;

    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
    private int UpdateDeletedRows(SisaDev_Cot dataSet, List<DataRow> allChangedRows) => 0;
