...
// Type: SisaDev.SisaDev_FRTableAdapters.sp_CargarFacturasEmitidasTableAdapter
...
namespace SisaDev.SisaDev_FRTableAdapters
{
  ...
  public class sp_CargarFacturasEmitidasTableAdapter : Component
  {
    ...
    public sp_CargarFacturasEmitidasTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "sp_CargarFacturasEmitidas",
        ColumnMappings = {
          {
            "IdFacturasEmitidas",
            "IdFacturasEmitidas"
    ...
    public virtual int Fill(
      SisaDev_FR.sp_CargarFacturasEmitidasDataTable dataTable,
      string id)
    {
    ...
    public virtual SisaDev_FR.sp_CargarFacturasEmitidasDataTable GetData(string id)
    {
      ...
      if (id == null)
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) id;
      SisaDev_FR.sp_CargarFacturasEmitidasDataTable emitidasDataTable = new SisaDev_FR.sp_CargarFacturasEmitidasDataTable();
