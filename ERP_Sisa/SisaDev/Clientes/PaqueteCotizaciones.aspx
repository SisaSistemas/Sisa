<%@ Page Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="PaqueteCotizaciones.aspx.cs" Inherits="SisaDev.Clientes.PaqueteCotizaciones" %>
...
<asp:Content ID="body" ContentPlaceHolderID="MainContent" runat="server">
    <section id="main-content">
        <section class="wrapper">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="row col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-primary" id="btnAsignarPorcentaje" type="button" disabled>Asignar %</button>
                        </div>
                    </section>
                </div>
            </div>
            ...
            <%--VER ARCHIVOS--%>
            <div class="modal fade" data-backdrop="static" data-keyboard="false" id="GaleriaPorcentajeModal" tabindex="-1" role="dialog" aria-labelledby="GaleriaPorcentajeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="LabelGaleriaPorcentajeModal">Aplicar % de descuento</h4>
                        ...
                        <form class="form-horizontal ">
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" id="txtPorcentaje" placeholder="Porcentaje de descuento" />
                            </div>
                            <div class="modal-footer">
                                <button type="button" id="btnGuardaPorcentaje" class="btn btn-default" >Guardar</button>
                                <button type="button" id="btnCerrarModal" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<asp:Content ID="footer" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/PaqueteCotizaciones_CCM.js" type="text/javascript"></script>
</asp:Content>
