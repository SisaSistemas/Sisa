<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="PaquetesCotizaciones.aspx.cs" Inherits="SisaDev.Clientes.PaquetesCotizaciones" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/PaquetesCotizacionesSisa.js" type="text/javascript"></script>
</asp:Content>
