...
{
    public partial class CajaChicaCuautitlan : System.Web.UI.Page
    {
        ...
        public static string ObtenerCC(string pid)
        {
            ...
            if (pid.Trim() == "2")
            {
                ...
                {
                    str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaCuautitlan.Select((s => s)));
                }

            }
            if (rolesUsuarios.CajaChicaCuautitlan == true || rolesUsuarios.Tipo == "ROOT" || rolesUsuarios.Tipo == "GERENCIAL" || rolesUsuarios.Tipo == "ADMINISTRACION")
            {
                if (pid.Trim() == "1")
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.JT_LoadCajaChicaCuautitlan().Where((s =>
                        {
                ...
                else
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaCuautitlan.FirstOrDefault((s => s.IdCajaChicaCuautitlan.ToString() == pid)));
                    }
        ...
        public static string GuardarCC(string Responsable, string Concepto, string pidproyecto, string Proyecto, string Comprobante, string Abono, string Fecha, string Estatus, string Tipo, string pid, string Categoria, string CampoExtra, string OC, string nombrearchivo, string dataarchivo)
        {
            ...
            if (Tipo == "1")
            {
                if (rolesUsuarios.CajaChicaCuautitlan == true || rolesUsuarios.Tipo == "ROOT")
                {
                    if (pidproyecto == "1")
                        pidproyecto = "";
                    else
                    ...
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaCuautitlan add = new tblCajaChicaCuautitlan()
                        {
                        ...
                        sisaEntitie.tblCajaChicaCuautitlan.Add(add);
                        ...
                        if (!(Categoria == "N/A"))
                        {
                            tblEficienciasDesglose eficienciasDesglose1 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == add.IdCajaChicaCuautitlan.ToString())));
                            if (eficienciasDesglose1 != null)
                            {
                                eficienciasDesglose1.idProyecto = pidproyecto;
                                eficienciasDesglose1.idDocumento = add.IdCajaChicaCuautitlan.ToString();
                            ...
                            else
                            {
                                ...
                                {
                                    idProyecto = pidproyecto,
                                    idDocumento = add.IdCajaChicaCuautitlan.ToString(),
            ...
            else if (Tipo == "2")
            {
                if (rolesUsuarios.CajaChicaEditar)
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaCuautitlan Existe = (sisaEntitie.tblCajaChicaCuautitlan.FirstOrDefault((a => a.IdCajaChicaCuautitlan.ToString() == pid)));
                        if (Existe != null)
                        {
                            int int32 = Convert.ToInt32(Estatus);
                            ...
                            if (!(Categoria == "N/A"))
                            {
                                tblEficienciasDesglose eficienciasDesglose3 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == Existe.IdCajaChicaCuautitlan.ToString())));
                                if (eficienciasDesglose3 != null)
                                {
                                    eficienciasDesglose3.idProyecto = pidproyecto;
                                    eficienciasDesglose3.idDocumento = Existe.IdCajaChicaCuautitlan.ToString();
                                ...
                                else
                                {
                                    ...
                                    {
                                        idProyecto = pidproyecto,
                                        idDocumento = Existe.IdCajaChicaCuautitlan.ToString(),
                                        Categoria = Categoria.ToUpper(),
                                        Total = new Decimal?(num),
                                        TipoDoc = "CCC",
                                        Folio = "",
        ...
        public static string EliminarCC(string pid)
        {
            ...
            if (CajaChicaCuautitlan.rolesUsuarios.CajaChicaCuautitlan == true || CajaChicaCuautitlan.rolesUsuarios.Tipo == "ROOT")
            {
                using (SisaEntitie sisaEntitie = new SisaEntitie())
                {
                    tblCajaChicaCuautitlan tblCajaChica = (sisaEntitie.tblCajaChicaCuautitlan.FirstOrDefault((s => s.IdCajaChicaCuautitlan.ToString() == pid)));
                    if (tblCajaChica != null)
                    {
                        sisaEntitie.tblCajaChicaCuautitlan.Remove(tblCajaChica);
                        if (sisaEntitie.SaveChanges() > 0)
                        {
        ...
        public static string GuardarImagenTarea(string IdCajaChica, string FileName, string FileSize, string FileType, string File)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(@"C:\SisaFiles\CajaChicaCuautitlan\" + @"\" + FileName))
                {
                    System.IO.File.Delete(@"C:\SisaFiles\CajaChicaCuautitlan\" + @"\" + FileName);
                }

                string[] completo64 = File.Split(',');
                //var originalString = ASCIIEncoding.ASCII.GetString(Convert.FromBase64String(completo64[1]));
                //string archivo = @"\\Win-s20lmo4rao9\d\Proyectos\" + folioProyecto + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                string archivo = @"C:\SisaFiles\CajaChicaCuautitlan\" + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                using (FileStream Writer = new System.IO.FileStream(archivo, FileMode.Create, FileAccess.Write))
                {
                    Writer.Write(Convert.FromBase64String(completo64[1]), 0, Convert.FromBase64String(completo64[1]).Length);
                }
