<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="CajaChicaIrapuato.aspx.cs" Inherits="SisaDev.Administracion.CajaChicaIrapuato" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/CajaChicaIrapuato.js" type="text/javascript"></script>
</asp:Content>
