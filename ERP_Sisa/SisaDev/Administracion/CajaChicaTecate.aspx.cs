...
{
    public partial class CajaChicaTecate : System.Web.UI.Page
    {
        ...
        public static string ObtenerCC(string pid)
        {
            ...
            if (pid.Trim() == "2")
            {
                ...
                {
                    str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaTecate.Select((s => s)));
                }

            }
            if (rolesUsuarios.CajaChicaTecate == true || rolesUsuarios.Tipo == "ROOT" || rolesUsuarios.Tipo == "GERENCIAL" || rolesUsuarios.Tipo == "ADMINISTRACION")
            {
                if (pid.Trim() == "1")
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.JT_LoadCajaChicaTecate().Where((s =>
                        {
                ...
                else
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaTecate.FirstOrDefault((s => s.IdCajaChicaTecate.ToString() == pid)));
                    }
        ...
        public static string GuardarCC(string Responsable, string Concepto, string pidproyecto, string Proyecto, string Comprobante, string Abono, string Fecha, string Estatus, string Tipo, string pid, string Categoria, string CampoExtra, string OC, string nombrearchivo, string dataarchivo)
        {
            ...
            if (Tipo == "1")
            {
                if (rolesUsuarios.CajaChicaTecate == true || rolesUsuarios.Tipo == "ROOT")
                {
                    if (pidproyecto == "1")
                        pidproyecto = "";
                    else
                    ...
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaTecate add = new tblCajaChicaTecate()
                        {
                        ...
                        sisaEntitie.tblCajaChicaTecate.Add(add);
                        ...
                        if (!(Categoria == "N/A"))
                        {
                            tblEficienciasDesglose eficienciasDesglose1 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == add.IdCajaChicaTecate.ToString())));
                            if (eficienciasDesglose1 != null)
                            {
                                eficienciasDesglose1.idProyecto = pidproyecto;
                                eficienciasDesglose1.idDocumento = add.IdCajaChicaTecate.ToString();
                                eficienciasDesglose1.Categoria = Categoria.ToUpper();
                                eficienciasDesglose1.Total = new Decimal?(num);
                                eficienciasDesglose1.TipoDoc = "CCT";
                                sisaEntitie.SaveChanges();
                            }
                            else
                            {
                                ...
                                {
                                    idProyecto = pidproyecto,
                                    idDocumento = add.IdCajaChicaTecate.ToString(),
                                    Categoria = Categoria.ToUpper(),
                                    Total = new Decimal?(num),
                                    TipoDoc = "CCT",
                                    Folio = "",
                                    FechaDoc = new DateTime?(add.FechaAlta),
                                    idUsuarioUltimo = CajaChicaTecate.usuario.IdUsuario.ToString()
                                };
            ...
            else if (Tipo == "2")
            {
                if (rolesUsuarios.CajaChicaEditar)
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaTecate Existe = (sisaEntitie.tblCajaChicaTecate.FirstOrDefault((a => a.IdCajaChicaTecate.ToString() == pid)));
                        if (Existe != null)
                        {
                            int int32 = Convert.ToInt32(Estatus);
                            ...
                            if (!(Categoria == "N/A"))
                            {
                                tblEficienciasDesglose eficienciasDesglose3 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == Existe.IdCajaChicaTecate.ToString())));
                                if (eficienciasDesglose3 != null)
                                {
                                    eficienciasDesglose3.idProyecto = pidproyecto;
                                    eficienciasDesglose3.idDocumento = Existe.IdCajaChicaTecate.ToString();
                                    eficienciasDesglose3.Categoria = Categoria.ToUpper();
                                    eficienciasDesglose3.Total = new Decimal?(num);
                                    eficienciasDesglose3.TipoDoc = "CCT";
                                    sisaEntitie.SaveChanges();
                                }
                                else
                                {
                                    ...
                                    {
                                        idProyecto = pidproyecto,
                                        idDocumento = Existe.IdCajaChicaTecate.ToString(),
                                        Categoria = Categoria.ToUpper(),
                                        Total = new Decimal?(num),
                                        TipoDoc = "CCT",
                                        Folio = "",
        ...
        public static string EliminarCC(string pid)
        {
            ...
            if (CajaChicaCuautitlan.rolesUsuarios.CajaChicaTecate == true || CajaChicaCuautitlan.rolesUsuarios.Tipo == "ROOT")
            {
                using (SisaEntitie sisaEntitie = new SisaEntitie())
                {
                    tblCajaChicaTecate tblCajaChica = (sisaEntitie.tblCajaChicaTecate.FirstOrDefault((s => s.IdCajaChicaTecate.ToString() == pid)));
                    if (tblCajaChica != null)
                    {
                        sisaEntitie.tblCajaChicaTecate.Remove(tblCajaChica);
                        if (sisaEntitie.SaveChanges() > 0)
                        {
        ...
        public static string GuardarImagenTarea(string IdCajaChica, string FileName, string FileSize, string FileType, string File)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(@"C:\SisaFiles\CajaChicaTecate\" + @"\" + FileName))
                {
                    System.IO.File.Delete(@"C:\SisaFiles\CajaChicaTecate\" + @"\" + FileName);
                }

                string[] completo64 = File.Split(',');
                //var originalString = ASCIIEncoding.ASCII.GetString(Convert.FromBase64String(completo64[1]));
                //string archivo = @"\\Win-s20lmo4rao9\d\Proyectos\" + folioProyecto + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                string archivo = @"C:\SisaFiles\CajaChicaTecate\" + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                using (FileStream Writer = new System.IO.FileStream(archivo, FileMode.Create, FileAccess.Write))
                {
                    Writer.Write(Convert.FromBase64String(completo64[1]), 0, Convert.FromBase64String(completo64[1]).Length);
                }
