                    ...
                    <section class="panel">
                        ...
                        <form role="form" class="form-horizontal" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <%--<textarea style="width: 80%;" class="ckeditor" name="editor1" id="editor1" rows="15" runat="server">   </textarea>--%>
                            <textarea style="width: 80%;" name="editor1" id="editor1" rows="15" runat="server">   </textarea>
