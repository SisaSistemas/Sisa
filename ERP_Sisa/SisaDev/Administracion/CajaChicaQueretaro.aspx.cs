...
{
    public partial class CajaChicaQueretaro : System.Web.UI.Page
    {
        ...
        public static string ObtenerCC(string pid)
        {
            ...
            if (pid.Trim() == "2")
            {
                ...
                {
                    str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaQueretaro.Select((s => s)));
                }

            }
            if (rolesUsuarios.CajaChicaQueretaro == true || rolesUsuarios.Tipo == "ROOT" || rolesUsuarios.Tipo == "GERENCIAL" || rolesUsuarios.Tipo == "ADMINISTRACION")
            {
                if (pid.Trim() == "1")
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.JT_LoadCajaChicaQueretaro().Where((s =>
                        {
                ...
                else
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaQueretaro.FirstOrDefault((s => s.IdCajaChicaQueretaro.ToString() == pid)));
                    }
        ...
        public static string GuardarCC(string Responsable, string Concepto, string pidproyecto, string Proyecto, string Comprobante, string Abono, string Fecha, string Estatus, string Tipo, string pid, string Categoria, string CampoExtra, string OC, string nombrearchivo, string dataarchivo)
        {
            ...
            if (Tipo == "1")
            {
                if (rolesUsuarios.CajaChicaQueretaro == true || rolesUsuarios.Tipo == "ROOT")
                {
                    if (pidproyecto == "1")
                        pidproyecto = "";
                    else
                    ...
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaQueretaro add = new tblCajaChicaQueretaro()
                        {
                        ...
                        sisaEntitie.tblCajaChicaQueretaro.Add(add);
                        ...
                        if (sisaEntitie.SaveChanges() > 0)
                        {
                            if (nombrearchivo != "")
                            {
                                ...
                                string archivo = @"C:\SisaFiles\CajaChicaQueretaro\" + @"\" + dataarchivo;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                        ...
                        if (!(Categoria == "N/A"))
                        {
                            tblEficienciasDesglose eficienciasDesglose1 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == add.IdCajaChicaQueretaro.ToString())));
                            if (eficienciasDesglose1 != null)
                            {
                                eficienciasDesglose1.idProyecto = pidproyecto;
                                eficienciasDesglose1.idDocumento = add.IdCajaChicaQueretaro.ToString();
                                eficienciasDesglose1.Categoria = Categoria.ToUpper();
                                eficienciasDesglose1.Total = new Decimal?(num);
                                eficienciasDesglose1.TipoDoc = "CCQ";
                                sisaEntitie.SaveChanges();
                            }
                            else
                            {
                                ...
                                {
                                    idProyecto = pidproyecto,
                                    idDocumento = add.IdCajaChicaQueretaro.ToString(),
                                    Categoria = Categoria.ToUpper(),
                                    Total = new Decimal?(num),
                                    TipoDoc = "CCQ",
                                    Folio = "",
                                    FechaDoc = new DateTime?(add.FechaAlta),
                                    idUsuarioUltimo = CajaChicaQueretaro.usuario.IdUsuario.ToString()
                                };
            ...
            {
                if (rolesUsuarios.CajaChicaQueretaro == true)
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaQueretaro Existe = (sisaEntitie.tblCajaChicaQueretaro.FirstOrDefault((a => a.IdCajaChicaQueretaro.ToString() == pid)));
                        if (Existe != null)
                        {
                            int int32 = Convert.ToInt32(Estatus);
                            ...
                            if (!(Categoria == "N/A"))
                            {
                                tblEficienciasDesglose eficienciasDesglose3 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == Existe.IdCajaChicaQueretaro.ToString())));
                                if (eficienciasDesglose3 != null)
                                {
                                    eficienciasDesglose3.idProyecto = pidproyecto;
                                    eficienciasDesglose3.idDocumento = Existe.IdCajaChicaQueretaro.ToString();
                                    eficienciasDesglose3.Categoria = Categoria.ToUpper();
                                    eficienciasDesglose3.Total = new Decimal?(num);
                                    eficienciasDesglose3.TipoDoc = "CCQ";
                                    sisaEntitie.SaveChanges();
                                }
                                else
                                {
                                    ...
                                    {
                                        idProyecto = pidproyecto,
                                        idDocumento = Existe.IdCajaChicaQueretaro.ToString(),
                                        Categoria = Categoria.ToUpper(),
                                        Total = new Decimal?(num),
                                        TipoDoc = "CCQ",
                                        Folio = "",
        ...
        public static string EliminarCC(string pid)
        {
            ...
            if (CajaChicaCuautitlan.rolesUsuarios.CajaChicaQueretaro == true || CajaChicaCuautitlan.rolesUsuarios.Tipo == "ROOT")
            {
                using (SisaEntitie sisaEntitie = new SisaEntitie())
                {
                    tblCajaChicaQueretaro tblCajaChica = (sisaEntitie.tblCajaChicaQueretaro.FirstOrDefault((s => s.IdCajaChicaQueretaro.ToString() == pid)));
                    if (tblCajaChica != null)
                    {
                        sisaEntitie.tblCajaChicaQueretaro.Remove(tblCajaChica);
                        if (sisaEntitie.SaveChanges() > 0)
                        {
        ...
        public static string GuardarImagenTarea(string IdCajaChica, string FileName, string FileSize, string FileType, string File)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(@"C:\SisaFiles\CajaChicaQueretaro\" + @"\" + FileName))
                {
                    System.IO.File.Delete(@"C:\SisaFiles\CajaChicaQueretaro\" + @"\" + FileName);
                }

                string[] completo64 = File.Split(',');
                //var originalString = ASCIIEncoding.ASCII.GetString(Convert.FromBase64String(completo64[1]));
                //string archivo = @"\\Win-s20lmo4rao9\d\Proyectos\" + folioProyecto + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                string archivo = @"C:\SisaFiles\CajaChicaQueretaro\" + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                using (FileStream Writer = new System.IO.FileStream(archivo, FileMode.Create, FileAccess.Write))
                {
                    Writer.Write(Convert.FromBase64String(completo64[1]), 0, Convert.FromBase64String(completo64[1]).Length);
                }
