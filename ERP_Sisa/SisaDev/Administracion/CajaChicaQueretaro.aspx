<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="CajaChicaQueretaro.aspx.cs" Inherits="SisaDev.Administracion.CajaChicaQueretaro" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/CajaChicaQueretaro.js" type="text/javascript"></script>
</asp:Content>
