...
{
    public partial class CajaChicaChihuahua : System.Web.UI.Page
    {
        ...
        public static string ObtenerCC(string pid)
        {
            ...
            if (pid.Trim() == "2")
            {
                ...
                {
                    str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaChihuahua.Select((s => s)));
                }

            }
            if (rolesUsuarios.CajaChicaChihuahua == true || rolesUsuarios.Tipo == "ROOT" || rolesUsuarios.Tipo == "GERENCIAL" || rolesUsuarios.Tipo == "ADMINISTRACION")
            {
                if (pid.Trim() == "1")
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.JT_LoadCajaChicaChihuahua().Where((s =>
                        {
                ...
                else
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaChihuahua.FirstOrDefault((s => s.IdCajaChicaChihuahua.ToString() == pid)));
                    }
        ...
        public static string GuardarCC(string Responsable, string Concepto, string pidproyecto, string Proyecto, string Comprobante, string Abono, string Fecha, string Estatus, string Tipo, string pid, string Categoria, string CampoExtra, string OC, string nombrearchivo, string dataarchivo)
        {
            ...
            if (Tipo == "1")
            {
                if (rolesUsuarios.CajaChicaChihuahua == true || rolesUsuarios.Tipo == "ROOT")
                {
                    if (pidproyecto == "1")
                        pidproyecto = "";
                    else
                    ...
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaChihuahua add = new tblCajaChicaChihuahua()
                        {
                        ...
                        sisaEntitie.tblCajaChicaChihuahua.Add(add);
                        ...
                        if (!(Categoria == "N/A"))
                        {
                            tblEficienciasDesglose eficienciasDesglose1 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == add.IdCajaChicaChihuahua.ToString())));
                            if (eficienciasDesglose1 != null)
                            {
                                eficienciasDesglose1.idProyecto = pidproyecto;
                                eficienciasDesglose1.idDocumento = add.IdCajaChicaChihuahua.ToString();
                                eficienciasDesglose1.Categoria = Categoria.ToUpper();
                                eficienciasDesglose1.Total = new Decimal?(num);
                                eficienciasDesglose1.TipoDoc = "CCC";
                                sisaEntitie.SaveChanges();
                            }
                            else
                            {
                                ...
                                {
                                    idProyecto = pidproyecto,
                                    idDocumento = add.IdCajaChicaChihuahua.ToString(),
            ...
            {
                if (rolesUsuarios.CajaChicaChihuahua == true)
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaChihuahua Existe = (sisaEntitie.tblCajaChicaChihuahua.FirstOrDefault((a => a.IdCajaChicaChihuahua.ToString() == pid)));
                        if (Existe != null)
                        {
                            int int32 = Convert.ToInt32(Estatus);
                            ...
                            if (!(Categoria == "N/A"))
                            {
                                tblEficienciasDesglose eficienciasDesglose3 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == Existe.IdCajaChicaChihuahua.ToString())));
                                if (eficienciasDesglose3 != null)
                                {
                                    eficienciasDesglose3.idProyecto = pidproyecto;
                                    eficienciasDesglose3.idDocumento = Existe.IdCajaChicaChihuahua.ToString();
                                    eficienciasDesglose3.Categoria = Categoria.ToUpper();
                                    eficienciasDesglose3.Total = new Decimal?(num);
                                    eficienciasDesglose3.TipoDoc = "CCC";
                                    sisaEntitie.SaveChanges();
                                }
                                else
                                {
                                    ...
                                    {
                                        idProyecto = pidproyecto,
                                        idDocumento = Existe.IdCajaChicaChihuahua.ToString(),
                                        Categoria = Categoria.ToUpper(),
                                        Total = new Decimal?(num),
                                        TipoDoc = "CCC",
                                        Folio = "",
        ...
        {
            string str = string.Empty;
            CajaChicaChihuahua.usuario = HttpContext.Current.Session["UsuarioLogueado"] as tblUsuarios;
            CajaChicaChihuahua.rolesUsuarios = HttpContext.Current.Session["RolesUsuarioLogueado"] as tblRolesUsuarios;
            if (CajaChicaChihuahua.rolesUsuarios.CajaChicaChihuahua == true || CajaChicaChihuahua.rolesUsuarios.Tipo == "ROOT")
            {
                using (SisaEntitie sisaEntitie = new SisaEntitie())
                {
                    tblCajaChicaChihuahua tblCajaChica = (sisaEntitie.tblCajaChicaChihuahua.FirstOrDefault((s => s.IdCajaChicaChihuahua.ToString() == pid)));
                    if (tblCajaChica != null)
                    {
                        sisaEntitie.tblCajaChicaChihuahua.Remove(tblCajaChica);
                        if (sisaEntitie.SaveChanges() > 0)
                        {
        ...
        public static string GuardarImagenTarea(string IdCajaChica, string FileName, string FileSize, string FileType, string File)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(@"C:\SisaFiles\CajaChicaChihuahua\" + @"\" + FileName))
                {
                    System.IO.File.Delete(@"C:\SisaFiles\CajaChicaChihuahua\" + @"\" + FileName);
                }

                string[] completo64 = File.Split(',');
                //var originalString = ASCIIEncoding.ASCII.GetString(Convert.FromBase64String(completo64[1]));
                //string archivo = @"\\Win-s20lmo4rao9\d\Proyectos\" + folioProyecto + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                string archivo = @"C:\SisaFiles\CajaChicaChihuahua\" + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                using (FileStream Writer = new System.IO.FileStream(archivo, FileMode.Create, FileAccess.Write))
                {
                    Writer.Write(Convert.FromBase64String(completo64[1]), 0, Convert.FromBase64String(completo64[1]).Length);
                }
