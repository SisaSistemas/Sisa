<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="CajaChicaTecate.aspx.cs" Inherits="SisaDev.Administracion.CajaChicaTecate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/CajaChicaTecate.js" type="text/javascript"></script>
</asp:Content>
