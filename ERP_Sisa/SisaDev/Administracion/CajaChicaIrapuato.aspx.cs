...
{
    public partial class CajaChicaIrapuato : System.Web.UI.Page
    {
        ...
        public static string ObtenerCC(string pid)
        {
            ...
            if (pid.Trim() == "2")
            {
                ...
                {
                    str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaIrapuato.Select((s => s)));
                }

            }
            if (rolesUsuarios.CajaChicaIrapuato == true || rolesUsuarios.Tipo == "ROOT" || rolesUsuarios.Tipo == "GERENCIAL" || rolesUsuarios.Tipo == "ADMINISTRACION")
            {
                if (pid.Trim() == "1")
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.JT_LoadCajaChicaIrapuato().Where((s =>
                        {
                ...
                else
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        str = JsonConvert.SerializeObject(sisaEntitie.tblCajaChicaIrapuato.FirstOrDefault((s => s.IdCajaChicaIrapuato.ToString() == pid)));
                    }
        ...
        public static string GuardarCC(string Responsable, string Concepto, string pidproyecto, string Proyecto, string Comprobante, string Abono, string Fecha, string Estatus, string Tipo, string pid, string Categoria, string CampoExtra, string OC, string nombrearchivo, string dataarchivo)
        {
            ...
            if (Tipo == "1")
            {
                if (rolesUsuarios.CajaChicaIrapuato == true || rolesUsuarios.Tipo == "ROOT")
                {
                    if (pidproyecto == "1")
                        pidproyecto = "";
                    else
                    ...
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaIrapuato add = new tblCajaChicaIrapuato()
                        {
                        ...
                        sisaEntitie.tblCajaChicaIrapuato.Add(add);
                        ...
                        if (!(Categoria == "N/A"))
                        {
                            tblEficienciasDesglose eficienciasDesglose1 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == add.IdCajaChicaIrapuato.ToString())));
                            if (eficienciasDesglose1 != null)
                            {
                                eficienciasDesglose1.idProyecto = pidproyecto;
                                eficienciasDesglose1.idDocumento = add.IdCajaChicaIrapuato.ToString();
                                eficienciasDesglose1.Categoria = Categoria.ToUpper();
                                eficienciasDesglose1.Total = new Decimal?(num);
                                eficienciasDesglose1.TipoDoc = "CCI";
                                sisaEntitie.SaveChanges();
                            }
                            else
                            {
                                ...
                                {
                                    idProyecto = pidproyecto,
                                    idDocumento = add.IdCajaChicaIrapuato.ToString(),
                                    Categoria = Categoria.ToUpper(),
                                    Total = new Decimal?(num),
                                    TipoDoc = "CCI",
                                    Folio = "",
                                    FechaDoc = new DateTime?(add.FechaAlta),
                                    idUsuarioUltimo = CajaChicaIrapuato.usuario.IdUsuario.ToString()
                                };
            ...
            else if (Tipo == "2")
            {
                if (rolesUsuarios.CajaChicaEditar)
                {
                    using (SisaEntitie sisaEntitie = new SisaEntitie())
                    {
                        tblCajaChicaIrapuato Existe = (sisaEntitie.tblCajaChicaIrapuato.FirstOrDefault((a => a.IdCajaChicaIrapuato.ToString() == pid)));
                        if (Existe != null)
                        {
                            int int32 = Convert.ToInt32(Estatus);
                            ...
                            if (!(Categoria == "N/A"))
                            {
                                tblEficienciasDesglose eficienciasDesglose3 = (sisaEntitie.tblEficienciasDesglose.FirstOrDefault((e => e.idDocumento == Existe.IdCajaChicaIrapuato.ToString())));
                                if (eficienciasDesglose3 != null)
                                {
                                    eficienciasDesglose3.idProyecto = pidproyecto;
                                    eficienciasDesglose3.idDocumento = Existe.IdCajaChicaIrapuato.ToString();
                                    eficienciasDesglose3.Categoria = Categoria.ToUpper();
                                    eficienciasDesglose3.Total = new Decimal?(num);
                                    eficienciasDesglose3.TipoDoc = "CCI";
                                    sisaEntitie.SaveChanges();
                                }
                                else
                                {
                                    ...
                                    {
                                        idProyecto = pidproyecto,
                                        idDocumento = Existe.IdCajaChicaIrapuato.ToString(),
                                        Categoria = Categoria.ToUpper(),
                                        Total = new Decimal?(num),
                                        TipoDoc = "CCI",
                                        Folio = "",
        ...
        public static string EliminarCC(string pid)
        {
            ...
            if (CajaChicaCuautitlan.rolesUsuarios.CajaChicaIrapuato == true || CajaChicaCuautitlan.rolesUsuarios.Tipo == "ROOT")
            {
                using (SisaEntitie sisaEntitie = new SisaEntitie())
                {
                    tblCajaChicaIrapuato tblCajaChica = (sisaEntitie.tblCajaChicaIrapuato.FirstOrDefault((s => s.IdCajaChicaIrapuato.ToString() == pid)));
                    if (tblCajaChica != null)
                    {
                        sisaEntitie.tblCajaChicaIrapuato.Remove(tblCajaChica);
                        if (sisaEntitie.SaveChanges() > 0)
                        {
        ...
        public static string GuardarImagenTarea(string IdCajaChica, string FileName, string FileSize, string FileType, string File)
        {
            ...
            try
            {
                ...
                if (System.IO.File.Exists(@"C:\SisaFiles\CajaChicaIrapuato\" + @"\" + FileName))
                {
                    System.IO.File.Delete(@"C:\SisaFiles\CajaChicaIrapuato\" + @"\" + FileName);
                }

                string[] completo64 = File.Split(',');
                //var originalString = ASCIIEncoding.ASCII.GetString(Convert.FromBase64String(completo64[1]));
                //string archivo = @"\\Win-s20lmo4rao9\d\Proyectos\" + folioProyecto + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                string archivo = @"C:\SisaFiles\CajaChicaIrapuato\" + @"\" + FileName;//AppDomain.CurrentDomain.BaseDirectory + "Ventas\\docs\\" + p.Nombre;
                using (FileStream Writer = new System.IO.FileStream(archivo, FileMode.Create, FileAccess.Write))
                {
                    Writer.Write(Convert.FromBase64String(completo64[1]), 0, Convert.FromBase64String(completo64[1]).Length);
                }
