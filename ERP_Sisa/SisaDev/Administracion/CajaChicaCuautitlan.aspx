<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="CajaChicaCuautitlan.aspx.cs" Inherits="SisaDev.Administracion.CajaChicaCuautitlan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/CajaChicaCuautitlan.js" type="text/javascript"></script>
</asp:Content>
