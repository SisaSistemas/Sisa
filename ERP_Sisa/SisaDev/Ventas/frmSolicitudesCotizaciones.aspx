<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="frmSolicitudesCotizaciones.aspx.cs" Inherits="SisaDev.Ventas.frmSolicitudesCotizaciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        function VerDoc(btn) {
            //swal(btn.value);
            $('#testmodalpdf').html('');
            var params = "{'IdSolicitudCotizacion': '" + btn.value + "'}";

            $.ajax({
                async: true,
                url: "frmSolicitudesCotizaciones.aspx/VerPdf",
                dataType: "json",
                data: params,
                type: "POST",
                ...
                success: function (data, textStatus) {
                    ...
                    var archivo = '';
                    archivo = jsonArray.File;

                    document.getElementById('txtidProyectoArchivo').textContent = jsonArray.idArchivosIngenieria_CCM;
                    document.getElementById('txtTipoDocumento').textContent = "CCM";
                    $('#testmodalpdf').append('<object id="visorPDF" data="' + archivo + '" type="application/pdf" style="width:100%; height: 800px;"></object>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="main-content">
        <section class="wrapper">
                                ...
                                <div class="x_content">
                                    ...
                                    <div id="toolbar">
                                        <span class="d-inline-block btn-add-excel">
                                            <button type="button" class="btn btn-primary" id="btnSelect"><i class="icon_plus_alt2"></i> Solicitar Cotización</button>
                                            <%--<strong>|</strong>
                                    ...
                                    <table id="TablaCotizacion" class="table table-striped table-sm" data-search="true" data-show-refresh="true" data-show-export="true" data-query-params="queryParams" data-pagination="true" data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="NombreRequisitor" data-sortable="true"><i class="icon_archive_alt"></i>Requisitor</th>
                                                <th data-field="CDSID" data-sortable="true"><i class="icon_building"></i>CDSID</th>
                                                <th data-field="Objetivo" data-sortable="true"><i class="icon_creditcard"></i>Objetivo</th>
                                                <th data-field="Fecha" data-sortable="true" data-formatter="dateFormat"><i class="icon_profile"></i>Fecha Creacion</th>
                                                <th data-field="FechaEntrega" data-sortable="true" data-formatter="dateFormat"><i class="icon_creditcard"></i>Fecha Entrega</th>
                                                <th data-field="Estatus" data-formatter="estatusFormatter"><i class="fa-solid fa-check-to-slot"></i> Estatus</th>
            ...
            <%--Asignar Fecha--%>
            <div class="modal fade" data-backdrop="static" data-keyboard="false" id="dvFecha" tabindex="-1" role="dialog" aria-labelledby="dvFecha" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="LabeldvFecha">Asignar Fecha Compromiso</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            </button>
                        </div>
                        <form class="form-horizontal">
                            <div class="modal-body">
                                <div class="modal-body">
                                    <div class="col-md-10 col-sm-10 col-xs-12 form-group has-feedback">
                                        <input type="date" class="form-control has-feedback-left" id="txtFecha">
                                    </div>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                <span id="btnGuardarFecha" class="btn btn-success">Guardar</span>
                            </div>
                        </form>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/frmSolicitudesCotizaciones.js" type="text/javascript"></script>
</asp:Content>
