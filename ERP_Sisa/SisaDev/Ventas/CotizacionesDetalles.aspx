                    ...
                    <section class="panel">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <select id="cmbUsuariosCotizacion" class="col-sm-12 form-control selectpicker" data-live-search="true"></select>
                                <label><strong>Vendido por:</strong></label>
                                <select id="cmbUsuariosVendido" class="col-sm-12 form-control selectpicker" data-live-search="true"></select>
                            ...
                            <div class="col-sm-4">                                
                                ...
                                <select id="cmbSucursal" class="col-sm-12 form-control selectpicker" data-live-search="true"></select>
                            </div>
                        </div>
                        <!-- /.row -->
