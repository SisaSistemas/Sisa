...
<asp:Content ID="body" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <section class="panel">
                        ...
                        <div id="maina" class="col-md-6 col-sm-7 col-xs-12" style="height: 350px; "></div>
                        <div id="mainb" class="col-md-6 col-sm-5 col-xs-12" style="height: 350px;"></div>
                        
                        <div id="maind" class="col-md-6 col-sm-7 col-xs-12" style="height: 350px; "></div>
                        <div id="maine" class="col-md-6 col-sm-7 col-xs-12" style="height: 350px; "></div>
                ...
                <div class="col-lg-4">
                    <div id="mainc" class="col-md-12 col-sm-5 col-xs-12">
                            ...
                            <form class="form-inline" role="form" style="font-weight: bold;">
                                <div class="form-group">
                                    ...
                                    <span class="value text-success" id="lblTotalCotizacion">0.00 </span>
                                    <br />
                                    <span class="name">Total Gastado </span>
                                    <span class="value text-success" id="lblTotalGastos">2000 </span>
                                    <br />
                                    <span class="name">Flujo De Proyecto </span>
                                    <span class="value text-success" id="lblFlujoProyecto">2000 </span>
                                    <br />
                                    <span class="name">Utilidad De Proyecto </span>
                                    <span class="value text-success" id="lblUtilidadProyecto">2000 </span>
                                    <br />
                                    <span class="name">Duración Estimada </span>
                                    <span class="value text-success" id="lblDuracion">20 </span>
                                    <br />
                                    <span class="name">Total OC Pendiente Recibir</span>
                                    <span class="value text-success" id="lblGastosPend">2000 </span>
                                    <br />
                                    <span class="name">Lider</span>
                                    <span class="value text-success" id="lblLider">x </span>
                                    <br />
                                    <span class="name">Cliente</span>
                                    <span class="value text-success" id="lblCliente">x </span>
                                    <br />
                            ...
                            <br />
                            <button title="Proyeccion Financiera" class="btn btn-info" id="btnProyeccionFinanciera"><i class="icon_comment_alt"></i>Proyección Financiera</button>
                            <br />
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Mano de obra</td>
                                        <td>
                                            <label id="lblMOCotizado"></label>
                                        </td>
                                        <td>
                                            <label id="lblMOProyectado"></label>
                                        </td>
                                        <td>
                                            <label id="lblMOGastos"></label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Equipo</td>
                                        <td>
                                            <label id="lblECotizado"></label>
                                        </td>
                                        <td>
                                            <label id="lblEProyectado"></label>
                                        </td>
                                        <td>
                                            <label id="lblEGastos"></label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Materiales</td>
                                        <td>
                                            <label id="lblMCotizado"></label>
                                        </td>
                                        <td>
                                            <label id="lblMProyectado"></label>
                                        </td>
                                        <td>
                                            <label id="lblMGastos"></label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <label id="lblCajaChicaGastos"></label>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <label id="lblViaticosGastos"></label>
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <th>Totales</th>
                                        <th>
                                            <label style="font-weight: bold;" id="lblTotalCotizado"></label>
                                        </th>
                                        <th>
                                            <label style="font-weight: bold;" id="lblTotalProyectado"></label>
                                        </th>
                                        <th>
                                            <label style="font-weight: bold;" id="lblTotalGastoss"></label>
                                        </th>
                                        <th>
                                            <label style="font-weight: bold;" id="lblTotalEficiencia"></label>
                                        </th>
                                    </tr>
                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                            ...
                            <button title="Ir Doc Proyectos" class="btn btn-warning" id="btnDetalle" onclick="verDocumentos(this);"><i class="fa fa-rocket" aria-hidden="true"></i></button>
                            <br />
                            Actividad reciente
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="ProyeccionFinancieraModal" tabindex="-1" role="dialog" aria-labelledby="ProyeccionFinancieraModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="LabelAvanceProyectos">Proyeccion Financiera</h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt10" class="form-label">10%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt10">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt10Fecha">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt20">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt20Fecha">
                                </div>
                            </div>

                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt30">30%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt30">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt30Fecha">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt40">40%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt40">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt40Fecha">
                                </div>  
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control col-md-6" id="txt50">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control col-md-6" id="txt50Fecha">
                                </div>   
                            </div>

                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt60" class="form-label">60%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt60">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt60Fecha">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt70" class="form-label">70%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt70">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt70Fecha">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt80" class="form-label">80%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt80">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt80Fecha">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt90" class="form-label">90%</label>
                                </div>
                                    
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="txt90">
                                </div>
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt90Fecha">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="col-md-12">
                                    <label for="txt100" class="form-label">100%</label>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <input type="date" class="form-control" id="txt100Fecha">
                                </div>
                            ...
                            <label id="idProyecto" hidden="hidden"></label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        <button class="btn btn-danger" id="btnGuardarProyeccion" type="button">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
