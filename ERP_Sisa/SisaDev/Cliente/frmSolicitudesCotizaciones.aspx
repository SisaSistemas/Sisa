<%@ Page Title="" Language="C#" MasterPageFile="~/SitioCliente.Master" AutoEventWireup="true" CodeBehind="frmSolicitudesCotizaciones.aspx.cs" Inherits="SisaDev.Cliente.frmSolicitudesCotizaciones" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/frmSolicitudCotizaciones.js" type="text/javascript"></script>
</asp:Content>
