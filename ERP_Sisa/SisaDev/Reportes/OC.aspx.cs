    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (usuario != null)
            {
                ...
                {
                    ReportViewer1.LocalReport.DisplayName = "Reporte_OrdenCompra";
                    txtFechaIni.Text = Request.QueryString["fechaIni"].ToString();
                    txtFechaFin.Text = Request.QueryString["FechaFin"].ToString();
