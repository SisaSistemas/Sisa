$(document).ready(function () {
    ...
    if (URLactual.href.indexOf("CajaChicaChihuahua.aspx") > -1) {
...
function CargarCC() {
    ...
    $.ajax({
        dataType: "json",
        url: "CajaChicaChihuahua.aspx/ObtenerCC",
        async: true,
        data: parametros,
        type: "POST",
...
window.accionCC1Events = {
            ...
            success: function (data) {
                if (data.d != "") {
                    ...
                    $(json).each(function (index, item) {
                        var IdCajaChica = item.IdCajaChicaChihuahua;
    ...
    'click .verArchivo': function (e, value, row, index) {
        ...
        $.ajax({
            async: true,
            url: "CajaChicaChihuahua.aspx/CargarDocumentos",
            dataType: "json",
            data: params,
            type: "POST",
            contentType: "application/json; charset=utf-8",
        ...
        swal({
            ...
            reader.onload = function (e) {
                ...
                $.ajax({
                    dataType: "json",
                    async: true,
                    url: "CajaChicaChihuahua.aspx/GuardarImagenTarea",
                    data: params,
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
...
function CargarProyectos() {
    ...
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        type: 'POST',
        url: 'CajaChicaChihuahua.aspx/CargarCombos',
        data: params,
        success: function (data, textStatus) {
            //debugger;
...
function CargarOrdenCompra(id) {
    ...
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        type: 'POST',
        url: 'CajaChicaChihuahua.aspx/CargarOC',
        data: params,
        success: function (data, textStatus) {
...
$('#btnGuardarCajaChica').click(function () {
    ...
    $.ajax({
        dataType: "json",
        url: "CajaChicaChihuahua.aspx/GuardarCC",
        async: true,
        data: parametros,
        type: "POST",
        contentType: "application/json; charset=utf-8",
...
$('#btnEliminarCajaChica').click(function () {
    ...
    $.ajax({
        dataType: "json",
        url: "CajaChicaChihuahua.aspx/EliminarCC",
        async: true,
        data: parametros,
        type: "POST",
        contentType: "application/json; charset=utf-8",
...
function VerDoc(btn) {
    ...
    $.ajax({
        async: true,
        url: "CajaChicaChihuahua.aspx/VerPdf",
        dataType: "json",
        data: params,
        type: "POST",
        contentType: "application/json; charset=utf-8",
