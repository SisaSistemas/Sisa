$(document).ready(function () {
    ...
    $('#btnGuardarUsuarios').click(function () {
        ...
        var chkCuautitlan = $('#chkSucursalCuautitlanNew').is(':checked');
        var chkChihuahua = $('#chkSucursalChihuahuaNew').is(':checked');
        var chkUsa = $('#chkSucursalUsaNew').is(':checked');
        var chkHermosillo = $('#chkSucursalHermosilloNew').is(':checked');
        var chkIrapuato = $('#chkSucursalIrapuatoNew').is(':checked');
        var chkQueretaro = $('#chkSucursalQueretaroNew').is(':checked');
        var chkTecate = $('#chkSucursalTecateNew').is(':checked');
        //checkboxes
        ...
        var chkCajaCuautitlan = $('#chkCajaCuautitlan').is(':checked');
        var chkCajaChihuahua = $('#chkCajaChihuahua').is(':checked');
        var chkCajaUSA = $('#chkCajaUSA').is(':checked');
        var chkCajaIrapuato = $('#chkCajaIrapuato').is(':checked');
        var chkCajaQueretaro = $('#chkCajaQueretaro').is(':checked');
        var chkCajaTecate = $('#chkCajaTecate').is(':checked');
        ...
        var chkRptMonitor = $('#chkRptMonitor').is(':checked');
        ...
        var chkModuloPO = $('#chkModuloPO').is(':checked');
        var chkCostoIndirecto = $('#chkCostoIndirecto').is(':checked');
        ...
        if (txtNombreCompleto == "" || txtCorreoUsuario == "" || txtTelefonoUsuarios == "" || txtUsuario == "" || txtClaveUsuario == "" || Salario == "") {
            ...
            /*+ "', 'pSucursal': '" + slctSucursalUsuario + "',"*/
                + "', 'pchkCuautitlan': '" + chkCuautitlan + "'"
                + ", 'pchkChihuahua': '" + chkChihuahua + "'"
                + ", 'pchkUsa': '" + chkUsa + "'"
                + ", 'pchkHermosillo': '" + chkHermosillo + "'"
                + ", 'pchkIrapuato': '" + chkIrapuato + "'"
                + ", 'pchkQueretaro': '" + chkQueretaro + "'"
                + ", 'pchkTecate': '" + chkTecate + "'"
                ...
                + ",'pchkCajaCuautitlan': '" + chkCajaCuautitlan + "'"
                + ",'pchkCajaChihuahua': '" + chkCajaChihuahua + "'"
                + ",'pchkCajaUSA': '" + chkCajaUSA + "'"
                + ",'pchkCajaIrapuato': '" + chkCajaIrapuato + "'"
                + ",'pchkCajaQueretaro': '" + chkCajaQueretaro + "'"
                + ",'pchkCajaTecate': '" + chkCajaTecate + "'"
                ...
                + ",'pRptMonitor': '" + chkRptMonitor + "'"
                + ",'pchkModuloPO': '" + chkModuloPO + "'"
                + ",'pchkCostoIndirecto': '" + chkCostoIndirecto + "'"
                + "}";
    ...
    $('#btnModificarUsuarios').click(function () {
        ...
        var chkCuautitlan = $('#chkSucursalCuautitlan').is(':checked');
        var chkChihuahua = $('#chkSucursalChihuahua').is(':checked');
        var chkUsa = $('#chkSucursalUsa').is(':checked');
        var chkHermosillo = $('#chkSucursalHermosillo').is(':checked');
        var chkIrapuato = $('#chkSucursalIrapuato').is(':checked');
        var chkQueretaro = $('#chkSucursalQueretaro').is(':checked');
        var chkTecate = $('#chkSucursalTecate').is(':checked');
        ...
        var chkCajaCuautitlan = $('#chkCajaCuautitlanEditar').is(':checked');
        var chkCajaChihuahua = $('#chkCajaChihuahuaEditar').is(':checked');
        var chkCajaUSA = $('#chkCajaUSAEditar').is(':checked');
        var chkCajaIrapuato = $('#chkCajaIrapuatoEditar').is(':checked');
        var chkCajaQueretaro = $('#chkCajaQueretaroEditar').is(':checked');
        var chkCajaTecate = $('#chkCajaTecateEditar').is(':checked');
        ...
        var chkRptMonitor = $('#chkRptMonitorEditar').is(':checked');
        ...
        var chkModuloPO = $('#chkModuloPOEditar').is(':checked');
        var chkCostoIndirecto = $('#chkCostoIndirectoEditar').is(':checked');
            ...
            success: function (data) {
                if (data.d != "") {
                    ...
                    $(json).each(function (index, item) {
                        ...
                        $('#chkCajaCuautitlanEditar').prop('checked', item.CajaChicaCuautitlan);
                        $('#chkCajaChihuahuaEditar').prop('checked', item.CajaChicaChihuahua);
                        $('#chkCajaUSAEditar').prop('checked', item.CajaChicaUSA);
                        $('#chkCajaIrapuatoEditar').prop('checked', item.CajaChicaIrapuato);
                        $('#chkCajaQueretaroEditar').prop('checked', item.CajaChicaQueretaro);
                        $('#chkCajaTecateEditar').prop('checked', item.CajaChicaTecate);
                        ...
                        $('#chkRptMonitorEditar').prop('checked', item.rptMonitor);

                        $('#btnModificarUsuarios').val(item.IdUsuario);
                        $('#chkModuloPOEditar').prop('checked', item.ModuloPO);
                        $('#chkCostoIndirectoEditar').prop('checked', item.CostoIndirecto);
                    ...
                    var parametros = "{'IdUsuario': '" + row.IdUsuario + "'}";
                    $.ajax({
                        dataType: "json",
                        url: "Usuarios.aspx/ObtieneSucursales",
                        async: true,
                        data: parametros,
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            if (data.d != "") {
                                var cuautitlan = false;
                                var chihuahua = false;
                                var usa = false;
                                var hermosillo = false;
                                var irapuato = false;
                                var queretaro = false;
                                var tecate = false;
                                ...
                                $(json).each(function (index, item) {
                                    ...
                                    if (item.IdSucursal.toUpperCase() == 'E8FB7D08-3E75-4DD4-9D6F-18A31886B638') {
                                        cuautitlan = true;
                                    }

                                    if (item.IdSucursal.toUpperCase() == '4327A1A3-B1F1-438A-9C89-081B2FB69D08') {
                                        chihuahua = true;
                                    }

                                    if (item.IdSucursal.toUpperCase() == '56A03C71-BF9B-48E1-ABE0-D32A95B5FBDB') {
                                        usa = true;
                                    }

                                    if (item.IdSucursal.toUpperCase() == 'E9D0B53B-D8B7-493A-B26D-FAF66D906157') {
                                        hermosillo = true;
                                    }

                                    if (item.IdSucursal.toUpperCase() == 'AED5D6F1-86F9-4148-8A45-F97F4AD140A5') {
                                        irapuato = true;
                                    }

                                    if (item.IdSucursal.toUpperCase() == '1479126E-06FA-4F4B-BA36-380CF73A6912') {
                                        queretaro = true;
                                    }

                                    if (item.IdSucursal.toUpperCase() == 'F8E5400A-E1B5-4100-A990-E73E9DA59370') {
                                        tecate = true;
                                    }
                            ...
                            $('#chkSucursalCuautitlan').prop('checked', cuautitlan);
                            $('#chkSucursalChihuahua').prop('checked', chihuahua);
                            $('#chkSucursalUsa').prop('checked', usa);
                            $('#chkSucursalHermosillo').prop('checked', hermosillo);
                            $('#chkSucursalIrapuato').prop('checked', irapuato);
                            $('#chkSucursalQueretaro').prop('checked', queretaro);
                            $('#chkSucursalTecate').prop('checked', tecate);
