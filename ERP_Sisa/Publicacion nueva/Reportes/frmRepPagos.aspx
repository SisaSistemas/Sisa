<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="frmRepPagos.aspx.cs" Inherits="SisaDev.Reportes.frmRepPagos" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_building"></i>Pagos</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <div id="busquedarecibidos">
                                            ...
                                            <button class="btn btn-danger" id="btnBuscar" type="button">Buscar.</button>
                                        </div>
                                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/frmRepPagos.js" type="text/javascript"></script>
</asp:Content>
