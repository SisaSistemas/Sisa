<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SisaDev.Default" %>
    ...
    <form runat="server" class="login-form">
      <div class="login-wrap">
        ...
        <label class="checkbox">
                <span class="pull-left"> <a href="Cliente/Default.aspx"> Soy cliente</a></span> <br /><br />
                <span class="pull-left"> <a href="Biddings/Default.aspx"> Soy Proveedor</a></span>
                <span class="pull-right"> <a href="Account/RecuperarClave.aspx"> ¿Contraseña olvidada?</a></span><br />
            </label>
          <asp:Button runat="server" Text="Acceder" OnClick="btnLogin_Click" CssClass="btn btn-primary btn-lg btn-block" ID="btnLogin" />
