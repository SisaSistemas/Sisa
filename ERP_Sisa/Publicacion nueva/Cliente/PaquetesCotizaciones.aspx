<%@ Page Title="" Language="C#" MasterPageFile="~/SitioCliente.Master" AutoEventWireup="true" CodeBehind="PaquetesCotizaciones.aspx.cs" Inherits="SisaDev.Cliente.PaquetesCotizaciones" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="icon_building"></i>Listado Paquetes</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
                                ...
                                <div class="x_content">
                                    ...
                                    <div id="toolbar">
                                        <span class="d-inline-block btn-add-excel">
                                            <button type="button" class="btn btn-primary" id="btnSelect"><i class="icon_plus_alt2"></i> Crear Paquete</button>
                                            <%--<strong>|</strong>
                                    ...
                                    <table id="TablaPaquetes" class="table table-striped table-sm" data-search="true" data-show-refresh="true" data-show-export="true" data-query-params="queryParams" data-pagination="true" data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="NombreContacto" data-sortable="true"><i class="icon_archive_alt"></i>Contacto</th>
                                                <th data-field="Descuento" data-sortable="true"><i class="icon_percent_alt"></i>%</th>
                                                <th data-field="FechaCreado" data-sortable="true" data-formatter="dateFormat"><i class="icon_profile"></i>Fecha Creacion</th>
                                                <th data-align="center" data-formatter="accionPaqFormatter" data-events="accionPaqEvents"><i class="icon_ol"></i>Accion</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/PaquetesCotizaciones.js" type="text/javascript"></script>
</asp:Content>
