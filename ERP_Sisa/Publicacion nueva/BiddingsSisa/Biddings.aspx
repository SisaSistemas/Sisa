<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="Biddings.aspx.cs" Inherits="SisaDev.BiddingsSisa.Biddings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="modal fade" data-backdrop="static" data-keyboard="false" id="dvAgregarParticipante" tabindex="-1" role="dialog" aria-labelledby="GaleriaArchivosProyectosModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="LabelGaleriaArchicosProyectos">Agregar Participante</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            </button>
                        </div>
                        <form class="form-horizontal ">
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="col-sm-10">
                                        ...
                                        <select id="slctParticipante" class="form-control selectpicker" data-live-search="true">
                            ...
                            <div class="modal-footer">
                                ...
                                <span id="btnGuardarModal" class="btn btn-success">Guardar</span>
                            </div>
                        </form>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/BiddingsSisa.js" type="text/javascript"></script>
</asp:Content>
