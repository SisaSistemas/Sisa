<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="frmSolicitudCotizacion.aspx.cs" Inherits="SisaDev.Ventas.frmSolicitudCotizacion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="jsxpage" runat="server">
    <script src="<%= ResolveUrl("~") %>js/frmSolicitarCotizacion.js" type="text/javascript"></script>
</asp:Content>
