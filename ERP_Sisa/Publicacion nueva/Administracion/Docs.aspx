<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Docs.aspx.cs" Inherits="SisaDev.Administracion.Docs" %>
...
<body>
    <form id="uploader" method="post">
        ...
        <span id="file-input-container">
            <div id="alt-fileinput">
                <input id="filepath" name="filepath" type="text" style="width:150px;" runat="server"/>
                <button id="browse" name="browse" type="button" value="Browse" runat="server"></button>
            </div>
            <input id="newfile" name="newfile" type="file" />
        </span>
        <button id="upload" name="upload" type="submit" value="Upload" runat="server"></button>
        <button id="newfolder" name="newfolder" type="button" value="New Folder" runat="server"></button>
        <button id="grid" class="ON" type="button" runat="server">&nbsp;</button>
        <button id="list" type="button" runat="server">&nbsp;</button>
    </form>
    <div id="splitter">
        <div id="filetree"></div>
        <div id="fileinfo">
    ...
    <ul id="itemOptions" class="contextMenu" runat="server">
        ...
        <li class="delete separator" runat="server" id="a4"><a href="#delete">Eliminar</a></li>
    </ul>
