<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SisaDev.Biddings.Default" %>
    ...
    <div class="container">
        ...
        <form runat="server" class="login-form">
            <div class="login-wrap">
                <p class="login-img">
                    <img src="../img/logo.png" /><%--><i class="icon_lock_alt"></i>--%>
                </p>
                ...
                <asp:Button runat="server" Text="Acceder como Proveedor" OnClick="btnLoginProveedor_Click" CssClass="btn btn-primary btn-lg btn-block" ID="btnLoginProveedor" />
